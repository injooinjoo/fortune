...
|---|---|---|---|---|---|---|---|
| DEC-001 | P0 | Frozen commit SHA captured for this candidate | pending | run `git rev-parse HEAD` and paste in Decision Entry | release-owner | TBD | open |
| DEC-002 | P0 | Master checklist P0 items all pass | fail | `/docs/deployment/review/STORE_REVIEW_MASTER_CHECKLIST.md` (`COM-AUTO-001`, `COM-AUTO-004`, `TC-COMMON-003`) | release-owner | 2026-02-16 | blocked |
| DEC-003 | P1 | Master checklist P1 items all pass | fail | Open items: `RISK-001`, `RISK-002` in master checklist | release-owner | TBD | open |
...
| DEC-005 | P0 | Android evidence checklist has no open P0/P1 | fail | `/docs/deployment/review/ANDROID_REVIEW_EVIDENCE.md` (`AND-IAP-002`) | android-owner | TBD | open |
