...
- Latest chat refresh append: `180:2`
...
The latest official chat refresh currently lives on appended page `180:2` (`20 Chat Home / Character`) and should be treated as the freshest chat-page payload until the canonical range is consolidated. The earlier append `95:2` remains in the file as a superseded historical refresh.
