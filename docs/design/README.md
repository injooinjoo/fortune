...
- 현재 카탈로그 범위: active route surface `18`개, live `10`, placeholder `8`
- canonical current page roots: `89:2`-`94:2`
...
실제 수동 작업은 [FIGMA_APPEND_RENAME_RUNBOOK.md](./FIGMA_APPEND_RENAME_RUNBOOK.md)의 current canonical range `89:2`-`94:2` 기준으로 진행한다.
