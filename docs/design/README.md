...
- 현재 카탈로그 범위: active route surface `62`개, live `36`, placeholder `26`
...
실제 수동 작업은 [FIGMA_APPEND_RENAME_RUNBOOK.md](./FIGMA_APPEND_RENAME_RUNBOOK.md)의 appended page range `32:2`-`43:2` 기준으로 진행한다.
