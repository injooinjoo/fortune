...
- 현재 카탈로그 범위: active route surface `17`개, live `9`, placeholder `8`
- canonical current page roots: `64:2`-`69:2`
- manual delete targets: `32:2`, `33:2`, `34:2`, `38:2`, `39:2`, `42:2`, `43:2`, `63:2`
- already deleted from the official file: `60:2`, `61:2`, `62:2`
...
실제 수동 작업은 [FIGMA_APPEND_RENAME_RUNBOOK.md](./FIGMA_APPEND_RENAME_RUNBOOK.md)의 current canonical range `64:2`-`69:2`와 confirmed delete targets 기준으로 진행한다.
