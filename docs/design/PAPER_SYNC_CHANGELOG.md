...
| --- | --- | --- | --- | --- |
| 2026-04-06 | `KAN-226` | `awesome-design-md` 기반 agent-facing DESIGN.md 도입 | `DESIGN.md`, `docs/design/DESIGN_MD_WORKFLOW.md`, `docs/design/README.md`, `README.md` | No Paper artboard or route inventory changed. Added a root `DESIGN.md` derived from the current Fortune runtime and Paper-aligned tokens, documented its relationship to the Paper source of truth, and linked the workflow docs for future agent-driven UI work. |
| 2026-04-05 | `KAN-225` | Pencil MCP repo helper and setup documentation | `package.json`, `docs/development/MCP_SETUP_GUIDE.md`, `paper/README.md` | No Paper artboard or route inventory changed. Added repository-standard Pencil CLI helper commands and documented the official automatic Pencil MCP connection flow while keeping Paper as the design source of truth. |
