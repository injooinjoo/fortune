...
- `lib` Dart files: `438`
- Runtime reachable from `lib/main.dart`: `368`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 85 | `runtime_used` |
...
| `lib/core/models/fortune_result.dart` | 22 | `runtime_used` |
| `lib/core/widgets/paper_runtime_chrome.dart` | 18 | `runtime_used` |
...
| `lib/core/design_system/tokens/ds_colors.dart` | 16 | `runtime_used` |
| `lib/domain/entities/fortune.dart` | 16 | `runtime_used` |
