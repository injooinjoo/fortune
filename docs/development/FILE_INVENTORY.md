...
- Total inventory files: `2484`
- `lib` Dart files: `748`
- Runtime reachable from `lib/main.dart`: `636`
- Zero-incoming `lib` Dart files: `53`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 272 | `runtime_used` |
| `lib/core/utils/logger.dart` | 106 | `runtime_used` |
...
| `lib/core/utils/haptic_utils.dart` | 33 | `runtime_used` |
