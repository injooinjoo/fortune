...
- Total inventory files: `2076`
- `lib` Dart files: `407`
- Runtime reachable from `lib/main.dart`: `339`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 87 | `runtime_used` |
| `lib/core/utils/logger.dart` | 81 | `runtime_used` |
