...
- Total inventory files: `2169`
- `lib` Dart files: `505`
- Runtime reachable from `lib/main.dart`: `482`
- Zero-incoming `lib` Dart files: `3`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 138 | `runtime_used` |
...
| `lib/core/design_system/tokens/ds_colors.dart` | 20 | `runtime_used` |
