...
- Total inventory files: `2729`
- `lib` Dart files: `990`
- Runtime reachable from `lib/main.dart`: `635`
- Zero-incoming `lib` Dart files: `194`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 372 | `runtime_used` |
...
| `lib/core/design_system/theme/ds_extensions.dart` | 39 | `runtime_used` |
