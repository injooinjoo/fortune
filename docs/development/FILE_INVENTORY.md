...
| --- | --- | --- |
| `supabase/functions/_shared/llm/factory.ts` | 53 | `runtime_used` |
| `supabase/functions/_shared/llm/usage-logger.ts` | 46 | `runtime_used` |
...
| `supabase/functions/_shared/auth.ts` | 24 | `runtime_used` |
...
| `supabase/functions/_shared/notification_push.ts` | 6 | `runtime_used` |

## Focus Checks

- Unreferenced Edge Function directories: `65`
