...
- Total inventory files: `2492`
- `lib` Dart files: `752`
- Runtime reachable from `lib/main.dart`: `635`
- Zero-incoming `lib` Dart files: `57`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 273 | `runtime_used` |
| `lib/core/utils/logger.dart` | 108 | `runtime_used` |
| `supabase/functions/_shared/llm/factory.ts` | 55 | `runtime_used` |
| `supabase/functions/_shared/llm/usage-logger.ts` | 51 | `runtime_used` |
| `lib/domain/entities/fortune.dart` | 39 | `runtime_used` |
| `lib/core/design_system/theme/ds_extensions.dart` | 35 | `runtime_used` |
| `lib/core/utils/haptic_utils.dart` | 35 | `runtime_used` |
...
| `supabase/functions/_shared/cohort/index.ts` | 27 | `runtime_used` |
| `lib/core/models/fortune_result.dart` | 25 | `runtime_used` |
| `lib/features/character/presentation/utils/luts_tone_policy.dart` | 25 | `test_only` |
| `lib/services/storage_service.dart` | 25 | `runtime_used` |
...
- Declared asset directories with zero runtime refs: `91`
