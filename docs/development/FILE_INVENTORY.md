...
- Total inventory files: `2367`
- `lib` Dart files: `647`
- Runtime reachable from `lib/main.dart`: `636`
- Zero-incoming `lib` Dart files: `1`
...
| `lib/core/utils/logger.dart` | 95 | `runtime_used` |
...
| `lib/domain/entities/fortune.dart` | 35 | `runtime_used` |
...
| `lib/core/utils/haptic_utils.dart` | 31 | `runtime_used` |
