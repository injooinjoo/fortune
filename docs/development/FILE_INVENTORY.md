...
- Total inventory files: `2089`
- `lib` Dart files: `411`
- Runtime reachable from `lib/main.dart`: `343`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 92 | `runtime_used` |
...
| `lib/core/navigation/fortune_chat_route.dart` | 15 | `runtime_used` |
