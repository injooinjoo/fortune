...
- Total inventory files: `2575`
- `lib` Dart files: `835`
- Runtime reachable from `lib/main.dart`: `635`
- Zero-incoming `lib` Dart files: `104`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 306 | `runtime_used` |
| `lib/core/utils/logger.dart` | 122 | `runtime_used` |
| `supabase/functions/_shared/llm/factory.ts` | 55 | `runtime_used` |
| `supabase/functions/_shared/llm/usage-logger.ts` | 51 | `runtime_used` |
| `lib/domain/entities/fortune.dart` | 40 | `runtime_used` |
| `lib/core/utils/haptic_utils.dart` | 38 | `runtime_used` |
...
| `lib/shared/glassmorphism/glass_container.dart` | 30 | `runtime_used` |
| `lib/features/character/presentation/providers/character_chat_provider.dart` | 29 | `runtime_used` |
| `lib/core/design_system/tokens/ds_colors.dart` | 28 | `runtime_used` |
