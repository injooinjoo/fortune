...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 118 | `runtime_used` |
...
- Unreferenced Edge Function directories: `2`
- Missing function references with no directory target: `38`
