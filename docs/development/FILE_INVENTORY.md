...
- `lib` Dart files: `427`
- Runtime reachable from `lib/main.dart`: `361`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 104 | `runtime_used` |
...
| `lib/features/character/domain/models/ai_character.dart` | 18 | `runtime_used` |
