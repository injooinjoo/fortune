...
| `supabase/functions/_shared/notification_push.ts` | 10 | `runtime_used` |
| `supabase/functions/_shared/fortune-pricing-generated.ts` | 8 | `runtime_used` |
...
- Missing function references with no directory target: `15`
