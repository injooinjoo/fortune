...
- Total inventory files: `2028`
- `lib` Dart files: `388`
- Runtime reachable from `lib/main.dart`: `306`
...
| --- | --- | --- |
| `lib/core/utils/logger.dart` | 77 | `runtime_used` |
| `lib/core/design_system/design_system.dart` | 76 | `runtime_used` |
...
| `lib/services/storage_service.dart` | 16 | `runtime_used` |
| `lib/core/design_system/tokens/ds_spacing.dart` | 15 | `runtime_used` |
| `lib/features/character/domain/models/character_chat_message.dart` | 15 | `runtime_used` |
| `lib/core/utils/haptic_utils.dart` | 12 | `runtime_used` |
| `lib/features/character/domain/models/ai_character.dart` | 12 | `runtime_used` |
