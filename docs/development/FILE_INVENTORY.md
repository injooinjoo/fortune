...
- Total inventory files: `2700`
- `lib` Dart files: `961`
- Runtime reachable from `lib/main.dart`: `635`
- Zero-incoming `lib` Dart files: `179`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 355 | `runtime_used` |
...
| `lib/core/utils/haptic_utils.dart` | 48 | `runtime_used` |
| `lib/domain/entities/fortune.dart` | 44 | `runtime_used` |
| `lib/shared/glassmorphism/glass_container.dart` | 39 | `runtime_used` |
| `lib/core/design_system/theme/ds_extensions.dart` | 38 | `runtime_used` |
...
| `lib/core/design_system/tokens/ds_colors.dart` | 30 | `runtime_used` |
