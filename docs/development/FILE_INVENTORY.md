...
- Total inventory files: `2526`
- `lib` Dart files: `786`
- Runtime reachable from `lib/main.dart`: `635`
- Zero-incoming `lib` Dart files: `71`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 280 | `runtime_used` |
| `lib/core/utils/logger.dart` | 112 | `runtime_used` |
