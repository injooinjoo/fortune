...
- Total inventory files: `2455`
- `lib` Dart files: `719`
- Runtime reachable from `lib/main.dart`: `636`
- Zero-incoming `lib` Dart files: `35`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 249 | `runtime_used` |
| `lib/core/utils/logger.dart` | 104 | `runtime_used` |
