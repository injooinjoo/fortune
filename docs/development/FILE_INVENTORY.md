...
- Total inventory files: `2033`
- `lib` Dart files: `389`
- Runtime reachable from `lib/main.dart`: `311`
- Zero-incoming `lib` Dart files: `29`
...
| `lib/core/design_system/design_system.dart` | 74 | `runtime_used` |
...
| `lib/core/models/fortune_result.dart` | 23 | `runtime_used` |
...
| `lib/features/character/domain/models/character_chat_message.dart` | 16 | `runtime_used` |
| `lib/core/design_system/tokens/ds_spacing.dart` | 14 | `runtime_used` |
| `lib/core/navigation/fortune_chat_route.dart` | 13 | `runtime_used` |
| `lib/features/character/domain/models/ai_character.dart` | 13 | `runtime_used` |
