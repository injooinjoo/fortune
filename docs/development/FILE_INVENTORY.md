...
- Total inventory files: `2384`
- `lib` Dart files: `648`
- Runtime reachable from `lib/main.dart`: `636`
- Zero-incoming `lib` Dart files: `2`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 209 | `runtime_used` |
| `lib/core/utils/logger.dart` | 96 | `runtime_used` |
| `supabase/functions/_shared/llm/factory.ts` | 55 | `runtime_used` |
| `supabase/functions/_shared/llm/usage-logger.ts` | 51 | `runtime_used` |
| `lib/domain/entities/fortune.dart` | 36 | `runtime_used` |
...
- Missing function references with no directory target: `43`
- Undeclared top-level asset directories: `0`
- Declared asset directories with zero runtime refs: `93`
