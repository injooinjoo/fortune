...
- Total inventory files: `2135`
- `lib` Dart files: `435`
- Runtime reachable from `lib/main.dart`: `369`
- Zero-incoming `lib` Dart files: `25`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 110 | `runtime_used` |
...
| `lib/services/storage_service.dart` | 21 | `runtime_used` |
| `lib/core/navigation/fortune_chat_route.dart` | 19 | `runtime_used` |
...
| `lib/features/character/presentation/providers/character_chat_provider.dart` | 15 | `runtime_used` |
