...
- Total inventory files: `2445`
- `lib` Dart files: `711`
- Runtime reachable from `lib/main.dart`: `482`
- Zero-incoming `lib` Dart files: `33`
...
| --- | --- | --- |
| `lib/core/design_system/design_system.dart` | 246 | `runtime_used` |
| `lib/core/utils/logger.dart` | 105 | `runtime_used` |
| `supabase/functions/_shared/llm/factory.ts` | 54 | `runtime_used` |
| `supabase/functions/_shared/llm/usage-logger.ts` | 50 | `runtime_used` |
| `lib/domain/entities/fortune.dart` | 38 | `runtime_used` |
...
| `lib/core/utils/haptic_utils.dart` | 32 | `runtime_used` |
...
| `lib/services/storage_service.dart` | 24 | `runtime_used` |

## Focus Checks

- Unreferenced Edge Function directories: `16`
- Missing function references with no directory target: `11`
