...
const SCREENS = [
  ...
  {
    id: 'account__profile__default',
    pageKey: '80-admin-policy-utility',
    title: 'Account Profile',
    frameName: 'Account Profile',
    routeHash: '#/profile',
    status: 'live',
    note: 'Authenticated account/settings page restored from the pre-KAN-71 profile IA with personal info, theme mode, saju summary, and character relationships.',
    sources: [
      'lib/routes/route_config.dart',
