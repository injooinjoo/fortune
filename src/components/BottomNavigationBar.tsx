...
export default function BottomNavigationBar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-t border-gray-200/50 px-4 py-2"
    >
              ...
              >
                ...
                <AnimatePresence>
                  {isActive && (
                    <motion.div
                      layoutId="activeTab"
                      className="absolute -top-1 -left-2 -right-2 -bottom-1 bg-purple-100 rounded-2xl"
                ...
                <AnimatePresence>
                  {isActive && (
                    <motion.div
                      className="absolute -top-3 w-1 h-1 bg-purple-600 rounded-full"
