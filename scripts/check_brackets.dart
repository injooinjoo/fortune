...
void main() async {
  final file = File('lib/features/fortune/presentation/pages/traditional_fortune_unified_page.dart');
  ...
  // Show lines around 534
  print('\nLines around,
    534:');
  for (int i = 530; i < 540 && i < lines.length; i++) {
    print('${i + 1}: ${lines[i]}');
  }
}