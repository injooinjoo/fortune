...
void main() async {
  ...
  // Fix pattern,
    1: Container with missing child parameter
  ...
  // Fix pattern,
    5: Missing closing parenthesis for Padding
  content = content.replaceAll('Padding(\npadding:', 'Padding(\n,
    padding:');
  
  // Fix pattern,
    6: SizedBox with missing comma
  content = content.replaceAll('width: double.infinity)\n,
    child:', 'width: double.infinity,\n,
    child:');
  
  // Fix pattern,
    7: Missing closing parenthesis for style
  ...
  // Fix pattern,
    11: Missing parenthesis and brackets
  content = content.replaceAll('),\n            SizedBox(height: AppSpacing.spacing8)])));', '),\n                ),\n              ),\n            ),\n            SizedBox(height: AppSpacing.spacing8),\n          ],\n        ),\n      ),\n    );');
  
  // Fix pattern,
    12: Fix the trailing comma issue
