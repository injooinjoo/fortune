...
Future<void> fixFile(String filePath) async {
  ...
  try {
    ...
    // Common pattern,
    1: Extra ), after style declarations
    ...
    // Common pattern,
    4: BoxDecoration/LinearGradient extra closing
    content = content.replaceAllMapped(
    ...
    // Common pattern,
    7: Fix mismatched brackets in lists
    content = content.replaceAllMapped(
