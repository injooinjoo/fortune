...
void main() async {
  ...
  // Fix pattern,
    1: copyWith with fontWeight outside parentheses
  ...
  // Fix pattern,
    2: copyWith with properties outside
  ...
  // Fix pattern,
    3: Missing closing parenthesis for copyWith
  ...
  // Fix pattern,
    4: Style with properties outside TextStyle parentheses
  ...
  // Fix pattern,
    5: withValues followed by comma and closing parenthesis
