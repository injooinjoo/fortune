...
class GoogleSignInPlugin extends GoogleSignInPlatform {
  ...
  Future<void> get initialized {
    ...
    return Future.wait<void>(
        <Future<void>>[_ensureSdkLoaded(), _initCalled!.future]);
  }
  ...
  Future<void> _ensureSdkLoaded() {
    return _jsSdkLoadedFuture ??=
        _debugOverrideLoader ? Future<void>.value() : loader.loadWebSdk();
  }
