                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: RadialGradient(
                        colors: [
                          (numberInfo['color'] as Color).withOpacity(0.2),
                          (numberInfo['color'] as Color).withOpacity(0.5),
                        ],
                      ),
                      boxShadow: [
                        BoxShadow(
                          color: (numberInfo['color'] as Color).withOpacity(0.3),
                          blurRadius: 30,
                          spreadRadius: 10,
                        ),
                      ],
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _buildTimeNumberCard('저녁', timeNumbers['evening']!, Icons.nights_stay),
              ],
            ),
          ],
        ),
    ...
    return GlassCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          ...[
            '중요한 약속은 행운 숫자와 관련된 시간에 잡아보세요', '전화번호나 비밀번호에 행운 숫자를 포함시켜보세요',
            '쇼핑이나 투자 시 행운 숫자 단위로 결정해보세요', '운동이나 목표 설정 시 행운 숫자를 활용하세요',
            '명상 시 행운 숫자를 반복해서 떠올려보세요'].map((tip) {
            return Padding(
              padding: const EdgeInsets.only(bottom: 12),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
