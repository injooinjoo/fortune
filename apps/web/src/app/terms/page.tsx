    ...
    >
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            웹 결제는 서버가 주문 금액과 토스페이먼츠 승인 결과를 모두 확인한 경우에만 한 번
            반영됩니다. 승인되지 않거나 금액이 다른 주문에는 온도가 지급되지 않습니다.
          </li>
          <li>
            웹 결제의 전액 환불 요청은 결제일로부터 7일 이내 고객 지원 또는 내 결제 화면에서
            접수할 수 있습니다. 이미 사용한 온도, 부분 환불 가능 여부, 법정 철회·환불 사유는
            실제 사용 내역과 관계 법령을 확인한 뒤 안내하며 법령상 권리가 본 기준보다 우선합니다.
          </li>
          <li>
            환불 완료 시 해당 결제로 지급된 미사용 온도와 보너스는 회수되며, 결제수단에 따라
            실제 환급까지 추가 영업일이 걸릴 수 있습니다.
          </li>
        </ul>
      </section>
