...
# Check if OndoWatch target already exists
if project.targets.find { |t| t.name == 'OndoWatch' }
  puts "OndoWatch target already exists!"
  exit 0
end

puts "Adding OndoWatch target..."
...
watch_target.build_configurations.each do |config|
  ...
  config.build_settings['CODE_SIGN_ENTITLEMENTS'] = 'OndoWatch/OndoWatch.entitlements'
...
# Find or create OndoWatch group
watch_group = project.main_group.find_subpath('OndoWatch', true)
watch_group.set_source_tree('<group>')
watch_group.set_path('OndoWatch')

# Add Swift files to the target
swift_files = Dir.glob('/Users/jacobmac/Desktop/Dev/fortune/ios/OndoWatch/**/*.swift')
swift_files.each do |file_path|
  relative_path = file_path.sub('/Users/jacobmac/Desktop/Dev/fortune/ios/OndoWatch/', '')
...
# Add Info.plist
info_plist_path = '/Users/jacobmac/Desktop/Dev/fortune/ios/OndoWatch/Info.plist'
if File.exist?(info_plist_path)
  info_ref = watch_group.new_file('Info.plist')
end

# Add entitlements
entitlements_path = '/Users/jacobmac/Desktop/Dev/fortune/ios/OndoWatch/OndoWatch.entitlements'
if File.exist?(entitlements_path)
  ent_ref = watch_group.new_file('OndoWatch.entitlements')
end

# Add Assets.xcassets if exists
assets_path = '/Users/jacobmac/Desktop/Dev/fortune/ios/OndoWatch/Assets.xcassets'
...
puts "OndoWatch target added successfully!"
puts "Please open Xcode and:"
puts "1. Select OndoWatch scheme"
