...
class FinalDesignCleanup {
  ...
  Future<void> run() async {
    ...
    print('Remaining issues: $remainingIssues');
  ...
  Future<void> scanFile(File file) async {
    ...
    if (colorMatches.isNotEmpty) {
      ...
      issues.add('Hardcoded colors: ${uniqueColors.join(", ")}');
    ...
    if (fontSizeMatches.isNotEmpty) {
      ...
      issues.add('Hardcoded font sizes: ${uniqueSizes.join(", ")}');
    ...
    if (paddingMatches.isNotEmpty) {
      issues.add('Hardcoded padding values: ${paddingMatches.length} occurrences');
    ...
    if (radiusMatches.isNotEmpty) {
      ...
      issues.add('Hardcoded border radius: ${uniqueRadius.join(", ")}');
    ...
    if (sizedBoxMatches.isNotEmpty) {
      issues.add('Hardcoded SizedBox dimensions: ${sizedBoxMatches.length} occurrences');
    ...
    if (containerMatches.isNotEmpty) {
      issues.add('Hardcoded Container dimensions: ${containerMatches.length} occurrences');
