# OpenAI Codex 문법 수정 요청 프롬프트 - Updated Batch 4/5
...
## ⚠️ 특별 주의 파일
- **lib/screens/onboarding/enhanced_onboarding_flow.dart** - 617개 에러로 최고 우선순위
- **lib/features/fortune/presentation/widgets/career_fortune_selector.dart** - 206개 에러
