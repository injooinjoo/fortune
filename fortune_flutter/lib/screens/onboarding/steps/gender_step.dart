...
class _GenderStepState extends State<GenderStep> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      n: 600.ms),
                SizedBox(height: context.fortuneTheme.formStyles.inputPadding.horizontal * 3.75),
      ...
      begin: Offset(0.8, 0.8),
                    ...
                    SizedBox(width: context.fortuneTheme.formStyles.inputPadding.horizontal * 1.25),
                    _buildGenderButton(
                      gender: Gender.male,
                      label: '남자',
                      isSelected: _selectedGender == Gender.male)
                    ).animate(delay: 600.ms).fadeIn(durati,
      on: 600.ms).scale(,
      begin: Offset(0.8, 0.8),
                      end: Offset(1, 1),
                      curve: Curves.easeOutBack)
