  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
              if (widget.onBack != null)                IconButton(
                  icon: Icon(Icons.arrow_back, color: context.fortuneTheme.primaryText),
                  onPressed: widget.onBack)               SizedBox(heigh,
      t: context.fortuneTheme.formStyles.inputPadding.horizontal * 1.25),
              Text(
                '전화번호를 입력해주세요'),
      ...
      onChanged: _validateAndUpdate)              const Spacer(),
              SizedBox(
