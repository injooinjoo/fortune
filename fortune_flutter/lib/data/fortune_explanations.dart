...
class FortuneExplanations {
  static const Map<String, Map<String, dynamic>> explanations = {
    ...
    'love': {
      ...
      'visualData': {
        'singleRoadmap': [
          {'step': 1, 'title': '자기 이해', 'icon': '🪞', 'description': '나를 먼저 알아가기'},
          {'step': 2, 'title': '매력 개발', 'icon': '💄', 'description': '나만의 매력 찾기'},
          {'step': 3, 'title': '만남 확대', 'icon': '👥', 'description': '새로운 인연 만들기'},
          {'step': 4, 'title': '인연 포착', 'icon': '💕', 'description': '운명의 상대 발견'},
        ],
        'couplePhases': [
          {'phase': '씨앗기', 'period': '0-3개월', 'icon': '🌱', 'description': '설렘과 호기심'},
          {'phase': '새싹기', 'period': '3-6개월', 'icon': '🌿', 'description': '서로 알아가기'},
          {'phase': '성장기', 'period': '6-12개월', 'icon': '🌳', 'description': '신뢰 구축'},
          {'phase': '안정기', 'period': '1년 이상', 'icon': '🌲', 'description': '깊은 유대감'},
        ],
      },
    },
    'career': {
      'title': '직업운',
      'description': '당신의 커리어가 빛날 시기와 방법을 알려드립니다. 오늘 직장에서 당신을 빛나게 할 행동과 사람을 찾아보세요.',
      'features': [
        '업무 능력 향상 시기',
        '인간관계 조언',
        '경력 개발 방향',
      ...
      'visualData': {
        'careerMatrix': {
          'quadrants': [
            {'name': '스타형', 'ability': 'high', 'opportunity': 'high', 'color': '#FFD700'},
            {'name': '리더형', 'ability': 'high', 'opportunity': 'low', 'color': '#4169E1'},
            {'name': '잠재형', 'ability': 'low', 'opportunity': 'low', 'color': '#90EE90'},
            {'name': '안정형', 'ability': 'low', 'opportunity': 'high', 'color': '#FFA500'},
          ],
        },
        'jobTypeScores': [
          {'type': '사무직', 'icon': '🏢', 'score': 4, 'activity': '프레젠테이션, 기획'},
          {'type': '창작직', 'icon': '🎨', 'score': 5, 'activity': '아이디어 구상, 작품 활동'},
          {'type': '영업직', 'icon': '💰', 'score': 3, 'activity': '기존 고객 관리'},
          {'type': '기술직', 'icon': '🔧', 'score': 4, 'activity': '신기술 학습, 문제 해결'},
    ...
    'wealth': {
      'title': '금전운',
      'description': '당신에게 흐르는 부의 에너지를 포착합니다. 돈이 들어오는 길을 열고, 새어나가는 구멍을 막아 풍요로운 삶을 만들어보세요.',
      'features': [
        '수입 증대 기회',
        '지출 관리 조언',
        '투자 적기 분석',
      ...
      'visualData': {
        ...
        'investmentSignals': [
          ...
          {'type': '암호화폐', 'signal': 'red', 'percentage': 30, 'note': '리스크 관리 중요'},
          {'type': '채권', 'signal': 'green', 'percentage': 85, 'note': '안정적 수익 기대'},
        ],
      },
    },
    'health': {
      ...
      'visualData': {
        ...
        'healthChecklist': [
          {'item': '아침 스트레칭 (10분)', 'icon': '🌅', 'completed': false},
          {'item': '물 8잔 이상 섭취', 'icon': '💧', 'completed': false},
          {'item': '채소 중심 식단', 'icon': '🥗', 'completed': false},
          {'item': '30분 이상 걷기', 'icon': '🚶', 'completed': false},
          {'item': '7시간 이상 수면', 'icon': '😴', 'completed': false},
        ],
      },
    },
    'saju': {
      ...
      'customSections': {
        'fourPillars': {
          'title': '사주의 구성',
          'description': '년주(年柱), 월주(月柱), 일주(日柱), 시주(時柱)로 구성되며, 각각이 인생의 다른 시기와 영역을 나타냅니다.',
        },
        'fiveElements': {
          'title': '오행의 균형',
    ...
    'mbti': {
      ...
      'specialNote': 'MBTI 유형을 정확히 알고 계신가요? 16personalities.com에서 무료로 검사할 수 있습니다.',
      'mbtiTypes': {
    ...
    'tarot': {
      'title': '타로 운세',
      'description': '오늘 당신을 위해 타로 카드가 전하는 신비로운 메시지입니다. 카드가 드러내는 당신의 무의식과 내면의 목소리를 들어보세요.',
      'features': [
        '카드 의미 해석',
        '상황별 조언',
        '미래 예측',
      ...
      'visualData': {
        'tarotCards': [
          {'position': '과거', 'card': 'The Fool', 'meaning': '새로운 시작, 순수함', 'icon': '🃏'},
          {'position': '현재', 'card': 'The Magician', 'meaning': '의지력, 창조', 'icon': '🎩'},
          {'position': '미래', 'card': 'The World', 'meaning': '완성, 성취', 'icon': '🌍'},
        ],
      },
    },
    'chemistry': {
      'title': '궁합 운세',
      'description': '두 사람이 만들어내는 특별한 케미스트리를 분석합니다. 서로를 더 깊이 이해하고 사랑하게 되는 비법을 발견해보세요.',
      'features': [
        '종합 궁합 점수',
        '분야별 궁합 분석',
        '관계 발전 가능성',
      ...
      'visualData': {
        ...
        'scoreInterpretation': [
          ...
          {'range': '70-79', 'grade': 'B급', 'meaning': '좋음', 'advice': '소통을 늘리세요'},
          {'range': '60-69', 'grade': 'C급', 'meaning': '보통', 'advice': '노력이 필요합니다'},
          {'range': '50-59', 'grade': 'D급', 'meaning': '노력 필요', 'advice': '전문가 상담 추천'},
        ],
      },
    },
    'business': {
      'title': '사업운',
      'description': '당신의 사업가 정신이 가장 빛날 순간을 포착합니다. 성공으로 가는 길이 열릴 때, 당신이 반드시 해야 할 행동을 알려드립니다.',
      'features': [
        '사업 성공 가능성',
        '투자 적기 분석',
        '파트너십 조언',
      ...
      'visualData': {
        'timeline': [
          {'phase': '준비기', 'duration': '3개월', 'icon': '⚠️', 'description': '시장 조사 및 계획'},
          {'phase': '시작기', 'duration': '6개월', 'icon': '🚀', 'description': '사업 시작 및 초기 운영'},
          {'phase': '성장기', 'duration': '1년', 'icon': '📈', 'description': '사업 확장 및 성장'},
          {'phase': '안정기', 'duration': '2년', 'icon': '💰', 'description': '수익 안정화'},
          {'phase': '확장기', 'duration': '3년+', 'icon': '🌍', 'description': '신규 시장 진출'},
        ],
        'industryScores': [
  ...
  static Map<String, dynamic> _getDefaultExplanation() {
    return {
      'title': '운세',
      'description': '당신만의 특별한 운세 이야기를 들려드립니다. 매일 새로운 기대감으로 찾아주세요. 당신의 하루를 더 특별하게 만들어드릴게요.',
      'features': [
        '전문적인 운세 분석',
        '맞춤형 조언 제공',
        '행운 아이템 추천',
