    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Main content
          if (!_showCardSelection && !_showCardReveal) _buildMainContent(),
          
          // Card selection animation
          if (_showCardSelection && !_showCardReveal) TarotCardSelectionAnimation(
          ...
          // Card reveal
          if (_showCardReveal) _buildCardReveal(),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                        ...
                        colors: [
                          Color(0xFFFFA726), Color(0xFFFF7043), Color(0xFFE64A19),
                        ],
                      ),
                    ),
                    child: const Center(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _buildReadingOption('Career', Colors.green, Icons.trending_up),
              _buildReadingOption('Choice', Colors.orange, Icons.help_outline),
            ],
          ),
        ],
      ),
