...
/// 부적 타입 정의
enum TalismanType {
  wealth('재물부적', '재물운과 금전운을 상승시키는 부적', Icons.attach_money_rounded, [Color(0xFFFFD700), Color(0xFFFFB300)]),
  love('연애부적', '사랑과 인연을 불러오는 부적', Icons.favorite_rounded, [Color(0xFFFF69B4), Color(0xFFFF1493)]),
  health('건강부적', '건강과 장수를 기원하는 부적', Icons.spa_rounded, [Color(0xFF32CD32), Color(0xFF228B22)]),
  protection('액막이부적', '나쁜 기운과 액운을 막아주는 부적', Icons.shield_rounded, [Color(0xFF4169E1), Color(0xFF000080)]),
  success('성공부적', '목표 달성과 성공을 돕는 부적', Icons.star_rounded, [Color(0xFFFF4500), Color(0xFFDC143C)]),
  study('학업부적', '학업 성취와 합격을 기원하는 부적', Icons.school_rounded, [Color(0xFF8A2BE2), Color(0xFF4B0082)]),
  business('사업부적', '사업 번창과 번영을 기원하는 부적', Icons.business_rounded, [Color(0xFF20B2AA), Color(0xFF008B8B)]),
  family('가정화목부적', '가족의 화목과 평안을 지키는 부적', Icons.family_restroom_rounded, [Color(0xFFFF69B4), Color(0xFFFF69B4)]),
  custom('맞춤형부적', '개인의 소원을 담은 특별한 부적', Icons.auto_awesome_rounded, [Color(0xFF9370DB), Color(0xFF8B008B)]);
  ...
  const TalismanType(this.displayName, this.description, this.icon, this.gradientColors);
}
