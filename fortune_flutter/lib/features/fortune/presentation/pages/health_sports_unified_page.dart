...
enum HealthSportsType {
  health('건강운', 'health', '오늘의 건강 상태와 조언', Icons.favorite_rounded, [Color(0xFF10B981), Color(0xFF059669)]),
  fitness('피트니스', 'fitness', '운동 효과와 최적의 운동법', Icons.fitness_center_rounded, [Color(0xFFE91E63), Color(0xFFC2185B)]),
  yoga('요가', 'yoga', '요가 수행과 명상 가이드', Icons.self_improvement_rounded, [Color(0xFF9C27B0), Color(0xFF7B1FA2)]),
  golf('골프', 'golf', '골프 경기 운세와 스코어 예측', Icons.sports_golf_rounded, [Color(0xFF16A34A), Color(0xFF15803D)]),
  tennis('테니스', 'tennis', '테니스 경기 운세와 플레이 팁', Icons.sports_tennis_rounded, [Color(0xFF3B82F6), Color(0xFF2563EB)]),
  running('런닝', 'running', '러닝 컨디션과 최적의 코스', Icons.directions_run_rounded, [Color(0xFFFF6F00), Color(0xFFE65100)]),
      ...
      child: Column(
        ...
        children: [
          ...
          if (_selectedType == HealthSportsType.health && fortune.additionalInfo?['healthTips'] != null) ...[
            const SizedBox(height: 20),
            _buildHealthTips(List<String>.from(fortune.additionalInfo!['healthTips'] as List)),
          ],
          ...
          if ((_selectedType == HealthSportsType.fitness || 
            ...
            const SizedBox(height: 20),
            _buildExerciseTips(List<String>.from(fortune.additionalInfo!['exerciseTips'] as List)),
          ],
