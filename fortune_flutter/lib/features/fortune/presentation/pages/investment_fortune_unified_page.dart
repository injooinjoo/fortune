...
enum InvestmentType {
  wealth('재물운', 'wealth', '금전운과 재물운을 확인해보세요', Icons.attach_money_rounded, [Color(0xFF16A34A), Color(0xFF15803D)]),
  realestate('부동산', 'realestate', '부동산 투자 운세를 확인해보세요', Icons.home_rounded, [Color(0xFF059669), Color(0xFF047857)]),
  stock('주식', 'stock', '오늘의 주식 투자 운세를 확인해보세요', Icons.trending_up_rounded, [Color(0xFF1E88E5), Color(0xFF1565C0)]),
  crypto('암호화폐', 'crypto', '암호화폐 투자 운세를 확인해보세요', Icons.currency_bitcoin_rounded, [Color(0xFFFF6F00), Color(0xFFE65100)]),
      ...
      child: Column(
        ...
        children: [
          ...
          if (_selectedType == InvestmentType.lottery && fortune.additionalInfo?['luckyNumbers'] != null) ...[
            const SizedBox(height: 20),
            _buildLotteryNumbers(List<int>.from(fortune.additionalInfo!['luckyNumbers'] as List)),
          ],
          
          if (_selectedType == InvestmentType.stock && fortune.additionalInfo?['stockPicks'] != null) ...[
            const SizedBox(height: 20),
            _buildStockPicks(List<Map<String, dynamic>>.from(fortune.additionalInfo!['stockPicks'] as List)),
          ],
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  pick['trend'] ?? '',
                  style: TextStyle(
                    color: pick['trend'] == '상승' ? Colors.red : Colors.blue,
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ],
