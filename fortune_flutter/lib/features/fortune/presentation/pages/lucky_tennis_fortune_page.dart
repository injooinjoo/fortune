      ...
      child: GlassCard(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildEquipmentItem('스트링 텐션', '평소보다 1-2파운드 낮게', Icons.tune),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildConditionItem('체력', 85, Icons.battery_charging_full, Colors.green),
                _buildConditionItem('집중력', 92, Icons.visibility, Colors.blue),
                _buildConditionItem('반응속도', 78, Icons.speed, Colors.orange),
              ],
            ),
          ],
        ),
