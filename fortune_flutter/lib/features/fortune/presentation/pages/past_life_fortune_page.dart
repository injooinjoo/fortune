...
class PastLifeFortunePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return BaseFortunePageV2(
      ...
      inputBuilder: (context, onSubmit) => _PastLifeInputForm(onSubmit: onSubmit),
...
class _PastLifeInputForm extends StatelessWidget {
  final Function(Map<String, dynamic>) onSubmit;

  const _PastLifeInputForm({required this.onSubmit});
...
class _PastLifeFortuneResult extends StatelessWidget {
  final FortuneResult result;
  final VoidCallback onShare;

  const _PastLifeFortuneResult({
