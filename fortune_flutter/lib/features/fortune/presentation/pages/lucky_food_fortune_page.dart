...
class _LuckyFoodFortunePageState extends BaseFortunePageState<LuckyFoodFortunePage> {
      ...
      children: preferences.map((pref) {
        ...
        return ChoiceChip(
          label: Row(
            ...
            children: [
              Text(pref['icon'] as String, style: const TextStyle(fontSize: 18)),
  ...
  Widget _buildMealTimeSelector() {
    final mealTimes = [
      ...
      {'id': 'lunch', 'label': '점심', 'icon': Icons.wb_cloudy},
      {'id': 'dinner', 'label': '저녁', 'icon': Icons.nightlight_round},
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Text(
                primaryCategoryInfo['icon'] as String,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          nutritionData['benefit'] as String,
