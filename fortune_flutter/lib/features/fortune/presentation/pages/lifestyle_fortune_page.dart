...
class _LifestyleFortunePageState extends BaseFortunePageState<LifestyleFortunePage> {
  ...
  Widget buildFortuneResult(Fortune fortune) {
    switch (_selectedType) {
      case LifestyleType.health:
        return _buildHealthResult(fortune);
      case LifestyleType.biorhythm:
        return _buildBiorhythmResult(fortune);
      case LifestyleType.moving:
      case LifestyleType.movingDate:
        return _buildMovingResult(fortune);
    }
  }
  ...
  Widget _buildMovingResult(Fortune fortune) {
    final luckyDirections = fortune.luckyItems ?? [];
    final goodDates = fortune.additionalInfo?['goodDates'] ?? [];
