...
class _MarriageFortunePageState extends BaseFortunePageState<MarriageFortunePage> {
  ...
  Future<Map<String, dynamic>?> getFortuneParams() async {
    ...
    return {
      ...
      'relationshipExperience': _relationshipExperience,
    };
  }
  ...
  Widget _buildMarriageTimeline() {
    ...
    final timelineEvents = [
      ...
      {'age': 29, 'event': '연애 시작', 'probability': 70},
      {'age': 31, 'event': '결혼 적기', 'probability': 85},
      {'age': 33, 'event': '안정기', 'probability': 75},
    ];
  ...
  Widget _buildCompatibilityAnalysis() {
    ...
    final compatibilityFactors = [
      {'factor': '성격', 'score': 85, 'icon': Icons.psychology},
      {'factor': '가치관', 'score': 90, 'icon': Icons.balance},
      {'factor': '생활습관', 'score': 75, 'icon': Icons.home},
      {'factor': '미래계획', 'score': 80, 'icon': Icons.rocket_launch},
