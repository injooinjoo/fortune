...
class _HourlyFortunePageState extends BaseFortunePageState<HourlyFortunePage> {
      ...
      child: GlassCard(
        ...
        child: Column(
          ...
          children: [
            ...
            // Energy meters
            _buildEnergyMeter('에너지', hourlyDetails['energy'] as int, Colors.orange),
            const SizedBox(height: 12),
            _buildEnergyMeter('집중력', hourlyDetails['focus'] as int, Colors.blue),
            const SizedBox(height: 12),
            _buildEnergyMeter('사교성', hourlyDetails['social'] as int, Colors.green),
            const SizedBox(height: 12),
            _buildEnergyMeter('행운도', hourlyDetails['luck'] as int, Colors.purple),
            const SizedBox(height: 20),
            Text(
  ...
  Widget _buildLuckyHours() {
    ...
    final luckyHours = [
      {'time': '07:00-09:00', 'activity': '중요한 결정', 'score': 95},
      {'time': '13:00-14:00', 'activity': '창의적 작업', 'score': 88},
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        '${hour['score']}',
                        style: theme.textTheme.bodySmall?.copyWith(
                          color: _getScoreColor(hour['score'] as int),
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                    ),
