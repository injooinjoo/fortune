...
class _LuckyOutfitFortunePageState extends ConsumerState<LuckyOutfitFortunePage> {
  ...
  final List<Map<String, dynamic>> styleTypes = [
    {'id': 'classic', 'label': '클래식', 'icon': Icons.sentiment_satisfied},
    {'id': 'modern', 'label': '모던', 'icon': Icons.auto_awesome},
    {'id': 'casual', 'label': '캐주얼', 'icon': Icons.emoji_people},
    {'id': 'romantic', 'label': '로맨틱', 'icon': Icons.favorite_border},
    {'id': 'sporty', 'label': '스포티', 'icon': Icons.sports_handball},
    {'id': 'unique', 'label': '유니크', 'icon': Icons.palette},
  ];
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  result.luckyItems!['accessories'].toString(),
                  style: const TextStyle(
                    fontSize: 14,
                    height: 1.6,
                  ),
