...
enum FamilyType {
  children('자녀 운세', 'children', '우리 아이의 운세와 성장', Icons.child_care_rounded, [Color(0xFF3B82F6), Color(0xFF2563EB)]),
  parenting('육아 운세', 'parenting', '오늘의 육아 조언', Icons.family_restroom_rounded, [Color(0xFF10B981), Color(0xFF059669)]),
  pregnancy('태교 운세', 'pregnancy', '예비 엄마를 위한 태교 가이드', Icons.pregnant_woman_rounded, [Color(0xFFF59E0B), Color(0xFFD97706)], true),
      ...
      child: Column(
        ...
        children: [
          ...
          if ((_selectedType == FamilyType.parenting || _selectedType == FamilyType.children) && 
            ...
            const SizedBox(height: 20),
            _buildParentingTips(List<String>.from(fortune.additionalInfo!['parentingTips'] as List)),
          ],
          
          // Pregnancy tips
          if (_selectedType == FamilyType.pregnancy && fortune.additionalInfo?['pregnancyTips'] != null) ...[
            const SizedBox(height: 20),
            _buildPregnancyTips(List<String>.from(fortune.additionalInfo!['pregnancyTips'] as List)),
          ],
          
          // Family harmony tips
          if (_selectedType == FamilyType.harmony && fortune.additionalInfo?['harmonyTips'] != null) ...[
            const SizedBox(height: 20),
            _buildHarmonyTips(List<String>.from(fortune.additionalInfo!['harmonyTips'] as List)),
          ],
