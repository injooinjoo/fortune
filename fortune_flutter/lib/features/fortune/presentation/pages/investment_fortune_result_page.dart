      ...
      child: Column(
        ...
        children: [
          if (widget.investmentData.wantMarketTiming) ...[
            _buildTimingSection('오늘의 타이밍', timing['today'], Icons.today_rounded),
            const SizedBox(height: 24),
            _buildTimingSection('이번 주 타이밍', timing['week'], Icons.date_range_rounded),
            const SizedBox(height: 24),
            _buildTimingSection('이번 달 타이밍', timing['month'], Icons.calendar_month_rounded),
            const SizedBox(height: 24),
          ],
        ...
        Container(
          ...
          child: Column(
            children: [
              // Calendar grid here
              Text(
                '이번 달 투자 길일: ${luckyDays?.join(', ') ?? '15일, 23일, 28일'}',
                style: Theme.of(context).textTheme.bodyMedium,
              ),
            ],
          ),
