...
• 특별 파워 아이템: $specialItem

⏰ 아이템 파워 타임:
• 최고 효력 시간: ${powerHour}시 ${luckyMinute}분
• 아침 활성화: 오전 ${(powerHour % 12) == 0 ? 12 : (powerHour % 12)}시
• 저녁 충전: 오후 ${((powerHour + 12) % 12) == 0 ? 12 : ((powerHour + 12) % 12)}시
...
• 긍정적인 에너지가 주변으로 퍼져나갑니다$purposeRecommendation''';
    ...
    return Fortune(
      ...
      metadata: {
        ...
        'purposeInfo': _selectedPurpose != null ? _purposeInfo[_selectedPurpose] : null,
      },
    );
  }
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Icon(
                primaryCategoryInfo['icon'] as IconData,
                size: 64,
