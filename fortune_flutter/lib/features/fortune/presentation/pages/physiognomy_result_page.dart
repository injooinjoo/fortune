...
class _PhysiognomyResultPageState extends ConsumerState<PhysiognomyResultPage> 
  ...
  Widget _buildResultContent(ThemeData theme, Fortune fortune) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          // Overall Score Card
          _buildOverallScore(theme, scores['overall'] ?? 85),
          const SizedBox(height: 24),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          TweenAnimationBuilder<double>(
                            tween: Tween(begin: 0, end: (category['score'] as int) / 100),
  ...
  Widget _buildPersonalityTraits(ThemeData theme) {
    final traits = [
      {'trait': '리더십', 'level': 0.8, 'color': Colors.blue},
      {'trait': '창의성', 'level': 0.9, 'color': Colors.purple},
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  TweenAnimationBuilder<double>(
                    tween: Tween(begin: 0, end: trait['level'] as double),
