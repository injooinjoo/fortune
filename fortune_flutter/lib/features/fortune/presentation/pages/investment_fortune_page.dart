...
enum InvestmentType {
  ...
  realEstate('부동산', 'real_estate', Icons.home_work),
  lottery('복권', 'lottery', Icons.confirmation_number),
  general('종합', 'general', Icons.account_balance),
...
class InvestmentFortunePage extends BaseFortunePage {
  ...
  const InvestmentFortunePage({
    Key? key,
    this.initialType = InvestmentType.general,
  }) : super(
          key: key,
          title: '투자/재테크 운세',
        ...
        child: Column(
          ...
          children: [
            ...
            if (_selectedType != InvestmentType.general) ...[
              const SizedBox(height: 16),
              _buildRiskIndicator(fortune.score),
            ],
          ],
        ),
      ),
  ...
  Widget _buildStockContent() {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: 16),
        _buildRecommendationCard('오늘의 투자 전략', recommendations),
        const SizedBox(height: 16),
        _buildStockTips(),
      ],
    );
  ...
  Widget _buildCryptoContent() {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: 16),
        _buildRecommendationCard('암호화폐 투자 가이드', recommendations),
      ],
    );
  }
  ...
  Widget _buildRealEstateContent() {
    ...
    return Column(
      children: [
        ...
        _buildMarketTrend(),
        const SizedBox(height: 16),
        _buildRecommendationCard('부동산 투자 전략', recommendations),
      ],
    );
  }
  ...
  Widget _buildLotteryContent() {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: 16),
        _buildRecommendationCard('복권 구매 가이드', recommendations),
      ],
    );
  }
  ...
  Widget _buildSidejobContent() {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: 16),
        _buildRecommendationCard('부업 시작 가이드', recommendations),
      ],
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                _buildMarketIndicator('단기', 65, Colors.orange),
                _buildMarketIndicator('중기', 75, Colors.blue),
                _buildMarketIndicator('장기', 85, Colors.green),
              ],
            ),
          ],
        ),
