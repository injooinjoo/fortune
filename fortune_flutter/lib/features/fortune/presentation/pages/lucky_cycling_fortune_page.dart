...
class _CyclingInputFormState extends State<_CyclingInputForm> {
  ...
  Widget _buildBikeTypeGrid(ThemeData theme) {
    final types = [
      {'id': 'road', 'name': '로드바이크', 'icon': Icons.speed},
      {'id': 'mtb', 'name': 'MTB', 'icon': Icons.terrain},
      {'id': 'hybrid', 'name': '하이브리드', 'icon': Icons.directions_bike},
  ...
  Widget _buildTerrain(ThemeData theme) {
    final terrains = [
      {'id': 'flat', 'name': '평지', 'icon': Icons.horizontal_rule},
      {'id': 'hilly', 'name': '언덕', 'icon': Icons.trending_up},
      {'id': 'mountain', 'name': '산악', 'icon': Icons.terrain},
      {'id': 'mixed', 'name': '혼합', 'icon': Icons.waves},
    ];
