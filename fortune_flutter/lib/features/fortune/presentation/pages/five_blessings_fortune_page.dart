            ...
            child: InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: _selectedGoal == blessing['id']
                        ? blessing['color'] as Color
                        : Colors.grey[300]!,
                    width: _selectedGoal == blessing['id'] ? 2 : 1,
                  ),
                ),
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Icon(
                        blessing['icon'] as IconData,
                        color: blessing['color'] as Color,
                        size: 24,
                      ),
                    ),
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              Icon(
                selectedBlessing['icon'] as IconData,
                size: 64,
                color: selectedBlessing['color'] as Color,
              ),
              const SizedBox(height: 16),
              Text(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.auto_awesome, color: selectedBlessing['color'] as Color),
                    const SizedBox(width: 8),
                    const Text(
                      '당신의 오복 운세',
                      style: TextStyle(
                    ...
                    SizedBox(
                      ...
                      child: CircularProgressIndicator(
                        ...
                        valueColor: AlwaysStoppedAnimation<Color>(
                          selectedBlessing['color'] as Color,
                        ),
                      ),
                    ),
                    Column(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.format_list_numbered, color: selectedBlessing['color'] as Color),
                    const SizedBox(width: 8),
                    const Text(
                      '복을 받는 방법',
                      style: TextStyle(
