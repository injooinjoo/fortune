...
class _FishingInputFormState extends State<_FishingInputForm> {
  ...
  Widget _buildFishingType(ThemeData theme) {
    final types = [
      {'id': 'freshwater', 'name': '민물낚시', 'icon': Icons.water},
      {'id': 'sea', 'name': '바다낚시', 'icon': Icons.waves},
      {'id': 'fly', 'name': '플라이낚시', 'icon': Icons.air},
      {'id': 'ice', 'name': '얼음낚시', 'icon': Icons.ac_unit},
    ];
  ...
  Widget _buildFishingTime(ThemeData theme) {
    final times = [
      {'id': 'dawn', 'name': '새벽', 'icon': Icons.nights_stay},
      {'id': 'morning', 'name': '아침', 'icon': Icons.wb_twilight},
      {'id': 'afternoon', 'name': '오후', 'icon': Icons.wb_sunny},
      {'id': 'evening', 'name': '저녁', 'icon': Icons.nights_stay_outlined},
    ];
