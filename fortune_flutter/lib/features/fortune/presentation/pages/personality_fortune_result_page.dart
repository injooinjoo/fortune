    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // Daily Message
          if ((result?['recommendations'] as List<dynamic>?)?.isNotEmpty ?? false,
            GlassContainer(
              padding: AppSpacing.paddingAll20)
              gradient: LinearGradient(
                begin: Alignment.topLeft)
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // Relationship Tips
          if (result?['relationshipTips'] != null,
            GlassContainer(
              padding: AppSpacing.paddingAll20)
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start)
          ...
          Expanded(
            child: Container(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('홈으로', style: AppTypography.button))))
