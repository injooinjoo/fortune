...
class _CareerSeekerFortunePageState extends BaseFortunePageState<CareerSeekerFortunePage> {
  ...
  Widget _buildIndustryCompatibility() {
    ...
    final industries = [
      IndustryMatch('IT/테크', 95, Colors.blue),
      IndustryMatch('금융', 80, Colors.green),
      IndustryMatch('제조', 65, Colors.orange),
      IndustryMatch('서비스', 70, Colors.purple),
      IndustryMatch('공공', 55, Colors.red),
    ];
