...
enum PetType {
  general('반려동물', 'pet', '반려동물과의 교감과 건강', Icons.pets_rounded, [Color(0xFFE11D48), Color(0xFFBE123C)]),
  dog('반려견', 'dog', '강아지와의 특별한 하루', Icons.pets_rounded, [Color(0xFFDC2626), Color(0xFFB91C1C)]),
  cat('반려묘', 'cat', '고양이와의 행복한 일상', Icons.pets_rounded, [Color(0xFF9333EA), Color(0xFF7C3AED)]),
