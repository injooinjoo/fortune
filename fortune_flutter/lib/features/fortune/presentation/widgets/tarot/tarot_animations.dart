...
class TarotAnimations {
  ...
  static List<Animation<double>> createFanAnimations({
    ...
    print('[TarotAnim] Creating fan animations for $cardCount cards');
    print('[TarotAnim] delayFactor: $delayFactor');
  ...
  static FanSpreadPosition calculateFanPosition({
    ...
    print('[TarotAnim] calculateFanPosition - index: $index, total: $totalCards');
    final normalizedIndex = (index - totalCards / 2) / (totalCards / 2);
    print('[TarotAnim] normalizedIndex: $normalizedIndex');
    ...
    print('[TarotAnim] calculated scale: $scale');
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        print('[TarotEntrance] Animation progress: $progress');
        print('[TarotEntrance] Translation Y: ${50 * (1 - progress)}');
