...
class _TarotDeckSpreadWidgetState extends State<TarotDeckSpreadWidget>
  ...
  Widget _buildFanCard(int index, double screenWidth) {
    ...
    print('[TarotFan] Card $index - isSelected: $isSelected, isHovered: $isHovered');
    
    return AnimatedBuilder(
      animation: _fanAnimations[index],
      builder: (context, child) {
        final fanProgress = _fanAnimations[index].value;
        print('[TarotFan] Card $index - fanProgress: $fanProgress');
        ...
        return Transform(
          ...
          child: Opacity(
            opacity: (() {
              ...
              print('[TarotFan] Card $index - Calculating opacity: 0.3 + $fanProgress * 0.7 = $calculatedOpacity');
              ...
              return Transform(
                ...
                child: Opacity(
                  opacity: (() {
                    ...
                    print('[TarotStack] Card $index - isTop: $isTop, progress: $progress');
