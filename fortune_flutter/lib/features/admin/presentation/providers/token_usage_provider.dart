...
class TokenUsageNotifier extends StateNotifier<AsyncValue<TokenUsageDetailModel>> {
  final AdminApiService _adminApiService;
  final Ref _ref;
  
  TokenUsageNotifier(this._adminApiService, this._ref) : super(const AsyncValue.loading()) {
...
final tokenUsageProvider = StateNotifierProvider<TokenUsageNotifier, AsyncValue<TokenUsageDetailModel>>((ref) {
