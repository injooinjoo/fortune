...
class RedisStatsNotifier extends StateNotifier<AsyncValue<RedisStatsModel>> {
  ...
  RedisStatsNotifier(this._adminApiService) : super(const AsyncValue.loading()) {
    fetchRedisStats();
  }
...
final redisStatsProvider = StateNotifierProvider<RedisStatsNotifier, AsyncValue<RedisStatsModel>>((ref) {
