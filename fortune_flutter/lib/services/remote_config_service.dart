...
class RemoteConfigService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      Logger.info('Remote Config initialized. Updated: $updated');
  ...
  Future<void> _setDefaults() async {
    await _remoteConfig.setDefaults({
      ...
      tokenPackagesKey: json.encode([
        ...
        {'id': 'tokens50', 'amount': 50, 'price': 4500, 'bonus': 10},
        {'id': 'tokens100', 'amount': 100, 'price': 8000, 'bonus': 20},
        {'id': 'tokens200', 'amount': 200, 'price': 14000, 'bonus': 30},
      ]),
      popularTokenPackageKey: 'tokens100',
      
      // 온보딩 관련
      onboardingFlowKey: 'standard', // standard, simplified, detailed, progressive
      onboardingSkippableKey: false,
      
      // 운세 UI 관련
      fortuneUIStyleKey: 'modern', // modern, classic, minimal
      fortuneCardLayoutKey: 'card', // card, list, grid
      fortuneAnimationEnabledKey: true,
      
      // 결제 UI 관련
      paymentUILayoutKey: 'split', // split, unified, subscription_first, token_first
      paymentButtonStyleKey: 'rounded', // rounded, square, gradient
