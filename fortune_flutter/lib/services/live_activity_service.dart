...
class LiveActivityService {
  ...
  static Future<String?> startFortuneActivity({
    ...
    try {
      final activityId = await iOS.startLiveActivity(
        attributes: {
      ...
      if (activityId != null) {
        ...
        Logger.info('Started live activity: $fortuneType with ID: $activityId');
      }
  ...
  static Future<void> updateFortuneActivity({
    ...
    if (activityId == null) {
      Logger.warning('No active activity found for type: $fortuneType');
      return;
    }
    
    try {
      await iOS.updateDynamicIsland(
        activityId: activityId,
        content: updatedData,
      );
      Logger.info('Updated live activity: $fortuneType');
    } catch (e) {
  ...
  static Future<void> endFortuneActivity(String fortuneType) async {
    ...
    try {
      await iOS.endLiveActivity(activityId);
      _activeActivities.remove(fortuneType);
      Logger.info('Ended live activity: $fortuneType');
    } catch (e) {
