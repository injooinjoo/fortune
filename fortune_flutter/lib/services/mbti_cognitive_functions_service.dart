...
class MbtiCognitiveFunctionsService {
  ...
  static Map<String, dynamic> getDailyFortune(
    ...
    // 전체 점수 계산
    final overallScore = ((dominantLevel * 0.4 + auxiliaryLevel * 0.3 +
        cognitiveFunctions.values.reduce((a, b) => a + b) / 8 * 0.3) * 100).round();
    ...
    return {
      ...
      'message': _generateFortuneMessage(mbtiType, strongestToday, weakestToday),
      ...
      'cautionArea': _getCautionArea(weakestToday),
    };
  }
  ...
  static String _generateAdvice(String mbtiType, Map<String, double> functions) {
