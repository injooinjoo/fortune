...
class PhoneAuthService {
  ...
  Future<void> linkPhoneToAccount({
    ...
    try {
      ...
      debugPrint('Phone link initiated for $formattedPhone');
    } catch (e) {
      debugPrint('Failed to link phone: $e');
      throw _handleAuthError(e);
    }
  }
  ...
  Future<bool> isPhoneRegistered({
    ...
    try {
      ...
      debugPrint('Failed to check phone registration: $e');
      return false;
    }
  }
  ...
  Future<void> updateProfilePhone({
    ...
    try {
      ...
      debugPrint('Failed to update profile phone: $e');
      throw e;
    }
  }
  ...
  Exception _handleAuthError(dynamic error) {
    ...
    return Exception('인증 중 오류가 발생했습니다: ${error.toString()}');
  }
}