...
class ABTestManager {
  ...
  Future<void> setExperimentGroup(String experimentName, String variant) async {
    try {
      ...
      Logger.info('Set experiment group: $experimentName = $variant');
    } catch (e) {
  ...
  Future<void> logEvent({
    ...
    try {
      ...
      Logger.debug('Logged event: $eventName with params: $params');
    } catch (e) {
      Logger.error('Failed to log event: $eventName', e);
    }
  }
  ...
  Future<void> setUserProperties(Map<String, String> properties) async {
    try {
      ...
      Logger.info('Set user properties: ${properties.keys.join(', ')}');
    } catch (e) {
  ...
  Future<void> setUserId(String? userId) async {
    try {
      ...
      Logger.info('Set user ID: ${userId ?? 'null'}');
    } catch (e) {
