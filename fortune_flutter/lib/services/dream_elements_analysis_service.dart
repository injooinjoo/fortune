...
class DreamElementsAnalysisService {
  ...
  // 요소별 비중 계산
  static Map<String, double> calculateElementWeights(Map<String, List<String>> elements) {
  ...
  // 심리 상태 분석
  static Map<String, double> analyzePsychologicalState(Map<String, List<String>> elements) {
    final state = {
      '의식': 0.5,
      '무의식': 0.5,
      '긍정': 0.5,
  ...
  static Map<String, dynamic> generateDreamInterpretation(
    ...
    final interpretation = <String, dynamic>{
      ...
      'luckyElements': _identifyLuckyElements(elements),
    };
  ...
  static List<Map<String, String>> _getSymbolMeanings(Map<String, List<String>> elements) {
  ...
  static String _generatePsychologicalInsight(Map<String, List<String>> elements) {
