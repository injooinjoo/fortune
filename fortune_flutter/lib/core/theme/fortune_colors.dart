...
class FortuneColors {
  ...
  static const Color love = Color(0xFFFF3B57); // Warm red for emotional connections
  ...
  static const Color spiritualPrimary = mystical; // Alias for spiritual primary color
  static const Color spiritualDark = mysticalDark; // Alias for spiritual dark color
  static const Color spiritualLight = mysticalLight; // Alias for spiritual light color
