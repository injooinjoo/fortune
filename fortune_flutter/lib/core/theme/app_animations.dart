...
class AppAnimations {
  ...
  static const Duration durationMicro = Duration(milliseconds: 100);   // Hover, tap feedback
  static const Duration durationShort = Duration(milliseconds: 200);   // Fade, slide
  static const Duration durationMedium = Duration(milliseconds: 300);  // Expand, collapse
  static const Duration durationLong = Duration(milliseconds: 500);    // Page transitions
  static const Duration durationXLong = Duration(milliseconds: 800);   // Complex animations
  ...
  static const Duration delayStagger = Duration(milliseconds: 50);    // For staggered animations
