...
class AppSpacing {
  ...
  static const double buttonPaddingVertical = spacing3;    // 12px (adjusted for 48px height,
  ...
  static const double bottomNavPadding = spacing20;        // 80px (for content under bottom nav,
  ...
  static const EdgeInsets paddingHorizontal16 = EdgeInsets.symmetric(horizontal: spacing4);
  static const EdgeInsets paddingHorizontal24 = EdgeInsets.symmetric(horizontal: spacing6);
  static const EdgeInsets paddingVertical8 = EdgeInsets.symmetric(vertical: spacing2);
  static const EdgeInsets paddingVertical16 = EdgeInsets.symmetric(vertical: spacing4);
