    ...
    try {
      ...
      if (sajuState.sajuData == null && !sajuState.isLoading && widget.userProfile != null) {
        ...
        if (birthDate != null) {
          ...
          print('- birthDate: ${DateTime.parse(birthDate)}');
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: _getElementColor(pillar['cheongan']['element']).withValues(alpha: 0.3),
                  blurRadius: 4,
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: _getElementColor(pillar['jiji']['element']).withValues(alpha: 0.3),
                  blurRadius: 4,
                  offset: const Offset(0, 2),
                ),
              ],
