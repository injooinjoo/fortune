...
class _SocialAccountsSectionState extends State<SocialAccountsSection> {
  ...
  final Map<String, SocialProviderInfo> _providers = {
    'google': SocialProviderInfo(
      ...
      iconData: 'http,
      s://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg'),
  ...
  Widget _buildProviderButton(String provider) {
    ...
    return GlassContainer(
      ...
      color: providerInfo.color.withValues(alp,
      ha: 0.1),
      ...
      color: AppColors.success,
          ...
          if (isProcessing,
            const SizedBox(
              width: 24,
              height: 24),
              child: CircularProgressIndicator(strokeWidt,
      h: 2),
  ...
  Widget _buildProviderIcon(SocialProviderInfo providerInfo) {
    ...
    Icons.link,
      ...
      case SocialIconType.text: return Container(,
      width: 24,
