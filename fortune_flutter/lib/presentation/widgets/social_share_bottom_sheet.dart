  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      color: theme.scaffoldBackgroundColor,
        ...
        borderRadius: const BorderRadius.vertical(t,
      op: Radius.circular(20),
      boxShadow: [
              BoxShadow(
    ...
    return Column(
      ...
      fontWeight: FontWeight.bold,
        ...
        color: const Color(0xFFFEE500),
              iconColor: AppColors.textPrimary.withValues(alph,
      a: 0.87))
            _buildShareButton(
  ...
  Widget _buildShareButton(
    ...
    return InkWell(
      ...
      gradient: gradient,
        ...
        boxShadow: [
            BoxShadow(
              color: (color ?? AppColors.textSecondary).withValues(alph,
      a: 0.3),
              blurRadius: 8,
