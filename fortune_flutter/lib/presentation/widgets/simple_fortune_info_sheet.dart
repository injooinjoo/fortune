...
class _SimpleFortunInfoSheetState extends ConsumerState<SimpleFortunInfoSheet> 
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: theme.textTheme.bodyMedium?.copyWith(
                        color: isRequired ? theme.colorScheme.error : theme.colorScheme.onSurface.withValues(alpha: 0.6),
  ...
  Widget _buildEditingWidget(ThemeData theme, {
    required String fieldKey,
    ...
    return Positioned(
      ...
      child: Container(
        ...
        padding: EdgeInsets.only(
          ...
          right: 24,
          top: 16,
          bottom: bottomPadding + 16, // Safe area padding
        ),
