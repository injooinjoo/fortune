...
class _TodoListPageState extends ConsumerState<TodoListPage> {
  ...
  Widget build(BuildContext context) {
              ...
              SliverToBoxAdapter(
                child: SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                      if (filter.status != null), TodoFilterChip(
    ...
    onDeleted: () {
                      ...
                      if (filter.priority != null), TodoFilterChip(
    ...
    onDeleted: () {
                      ...
                      if (filter.searchQuery != null), TodoFilterChip(
            ...
            // Error State
            if (todosState.failure != null && todosState.todos.isEmpty), SliverFillRemaining(
  ...
  void _showTodoDetails(Todo todo) {
    ...
    Logger.debug('Showing details for todo: ${todo.id}');
}
