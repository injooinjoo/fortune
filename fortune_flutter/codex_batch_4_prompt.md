# OpenAI Codex 문법 수정 요청 프롬프트 - Batch 4/5
...
## ⚠️ 특별 주의 파일
- **lib/screens/profile/profile_screen.dart** - 543개 에러로 두 번째로 많은 문법 오류 포함
- **lib/screens/onboarding/onboarding_page_v2.dart** - 186개 에러 포함
