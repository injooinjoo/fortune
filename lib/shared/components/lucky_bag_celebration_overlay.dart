...
class LuckyBagCelebrationOverlay {
  ...
  static void show({
    ...
    _currentOverlay = OverlayEntry(
      builder: (context) => _LuckyBagCelebrationWidget(
        onComplete: () {
          _currentOverlay?.remove();
          _currentOverlay = null;
          onComplete?.call();
...
class _LuckyBagCelebrationWidget extends StatefulWidget {
  final VoidCallback onComplete;

  const _LuckyBagCelebrationWidget({
    required this.onComplete,
  });

  @override
  State<_LuckyBagCelebrationWidget> createState() =>
      _LuckyBagCelebrationWidgetState();
}

class _LuckyBagCelebrationWidgetState extends State<_LuckyBagCelebrationWidget>
