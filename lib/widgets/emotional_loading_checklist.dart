...
class _EmotionalLoadingChecklistState
  ...
  static const List<LoadingStep> _allMessages = [
    ...
    LoadingStep('금전 파동 분석 중', '재물의 흐름을 읽고 있어요'),
    LoadingStep('연애 기류 측정 중', '사랑의 에너지를 확인하고 있어요'),
    LoadingStep('건강 지수 확인 중', '몸과 마음의 건강을 체크하고 있어요'),
    ...
    LoadingStep('이름 궁합 계산 중', '당신 이름의 기운을 분석하고 있어요'),
    ...
    LoadingStep('직업 흐름 분석 중', '일터에서의 인사이트를 살펴보고 있어요'),
    LoadingStep('학업 에너지 체크 중', '공부와 배움의 기운을 확인하고 있어요'),
    LoadingStep('가족 조화 측정 중', '가족과의 관계를 보고 있어요'),
    LoadingStep('친구 자기장 분석 중', '친구들과의 인연을 살펴보고 있어요'),
    LoadingStep('여행 경로 탐색 중', '떠남과 돌아옴의 인사이트를 보고 있어요'),
    LoadingStep('창작 영감 수신 중', '예술과 창작의 기운을 받고 있어요'),
    LoadingStep('시험 집중력 측정 중', '중요한 순간의 인사이트를 확인하고 있어요'),
    LoadingStep('투자 흐름 예측 중', '돈의 흐름과 투자 인사이트를 보고 있어요'),
    LoadingStep('부동산 터 기운 분석 중', '땅과 집의 에너지를 읽고 있어요'),
    LoadingStep('차량 이동 에너지 체크 중', '교통과 이동의 인사이트를 확인하고 있어요'),
    LoadingStep('반려동물 교감 측정 중', '동물 친구들과의 인연을 보고 있어요'),
    LoadingStep('취미 열정 에너지 분석 중', '즐거움과 취미의 인사이트를 읽고 있어요'),
    LoadingStep('운동 체력 기운 체크 중', '몸의 건강과 활력을 확인하고 있어요'),
    LoadingStep('다이어트 의지력 측정 중', '몸매 관리 인사이트를 살펴보고 있어요'),
    LoadingStep('패션 스타일 감각 분석 중', '옷차림과 멋의 인사이트를 보고 있어요'),
    LoadingStep('뷰티 매력 지수 계산 중', '아름다움의 기운을 측정하고 있어요'),
    LoadingStep('요리 맛의 조화 체크 중', '음식과 요리의 인사이트를 확인하고 있어요'),
    LoadingStep('독서 지식 흡수력 분석 중', '책과 배움의 인연을 읽고 있어요'),
    LoadingStep('영화 감성 공명 측정 중', '영상과 이야기의 인사이트를 보고 있어요'),
    LoadingStep('음악 리듬 진동 분석 중', '소리와 멜로디의 기운을 읽고 있어요'),
    LoadingStep('게임 승부 기운 체크 중', '놀이와 경쟁의 인사이트를 확인하고 있어요'),
    LoadingStep('쇼핑 선택 감각 측정 중', '구매와 소비의 인사이트를 보고 있어요'),
    LoadingStep('소셜미디어 인기 지수 분석 중', '온라인 인연과 소통 인사이트를 읽고 있어요'),
    LoadingStep('카페 휴식 에너지 체크 중', '여유와 힐링의 기운을 확인하고 있어요'),
    LoadingStep('날씨 자연 조화 측정 중', '하늘과 바람의 메시지를 받고 있어요'),
    LoadingStep('꽃 생명력 기운 분석 중', '꽃과 식물의 에너지를 읽고 있어요'),
    LoadingStep('물 정화 에너지 체크 중', '물의 흐름과 정화 인사이트를 보고 있어요'),
    LoadingStep('불 열정 기운 측정 중', '태양과 열정의 에너지를 확인하고 있어요'),
    LoadingStep('바람 변화 흐름 분석 중', '바람이 가져올 변화를 읽고 있어요'),
    LoadingStep('마지막 인사이트 조합 중', '모든 인사이트를 하나로 엮고 있어요'),
  ];
