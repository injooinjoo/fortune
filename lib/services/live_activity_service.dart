...
class LiveActivityService extends ResilientService {
  ...
  bool get isSupported {
    try {
      ...
      Logger.warning('[$serviceName] Live Activities 지원 여부 확인 실패 (선택적 기능, iOS 버전 검증 실패): $e');
      return false;
    }
  }
  ...
  Future<String?> startFortuneActivity({
    ...
    return await safeExecuteWithNull(
      ...
      'Live Activity 시작: $fortuneType',
      'Live Activity 시작 실패, 기능 비활성화'
    );
  }
  ...
  Future<void> updateFortuneActivity({
    ...
    await safeExecute(
      ...
      'Live Activity 업데이트: $fortuneType',
      'Live Activity 업데이트 실패, 기능 유지'
    );
  }
  ...
  Future<void> endFortuneActivity(String fortuneType) async {
    await safeExecute(
      ...
      'Live Activity 종료: $fortuneType',
      'Live Activity 종료 실패, 상태는 유지'
    );
  }
  ...
  Future<void> endAllActivities() async {
    await safeExecute(
      ...
      '모든 Live Activities 종료',
      '일부 Live Activities 종료 실패, 상태는 유지'
    );
  }
