class ZodiacCompatibilityService {
  ...
  static double _calculateElementCompatibility(
    ...
    if (generatingPairs[element1] == element2 ||
        generatingPairs[element2] == element1) {
      return 0.8; // 상생
    }

    if (overcomingPairs[element1] == element2 ||
        overcomingPairs[element2] == element1) {
      return 0.3; // 상극
    }
  ...
  static Map<String, dynamic> getSpecialYears(String zodiac, int currentYear) {
    ...
    return {'years': birthYears, 'ages': ages, 'nextYear': null};
  }
