...
class ABTestManager {
  ...
  Future<void> setExperimentGroup(String experimentName, String variant) async {
    try {
      ...
      await _analytics.setUserProperty(
          name: 'exp_$experimentName', value: variant);
  ...
  Future<void> logEvent(
    ...
    try {
      ...
      await _analytics.logEvent(
          name: eventName, parameters: params.cast<String, Object>());
  ...
  Future<void> logScreenView(
    ...
    await logEvent(eventName: 'screen_view_custom', parameters: {
  ...
  Future<void> logConversion(
    ...
    switch (conversionType) {
      ...
      default:
        // 커스텀 전환 이벤트
        await logEvent(eventName: 'custom_conversion', parameters: params);
    }

    // 추가로 커스텀 전환 이벤트도 로깅
    await logEvent(eventName: 'conversion_$conversionType', parameters: params);
  }
  ...
  Future<void> logUserAction(
    ...
    await logEvent(eventName: 'user_action', parameters: params);
  }
  ...
  Future<void> logFunnelStep(
    ...
    await logEvent(eventName: 'funnel_step', parameters: params);
  }
  ...
  Future<void> logError(
    ...
    await logEvent(eventName: 'app_error', parameters: params);
  }
  ...
  Future<void> logPerformance(
    ...
    await logEvent(eventName: 'performance_metric', parameters: params);
  }
  ...
  Future<void> logExperimentExposure(
    ...
    await logEvent(eventName: 'experiment_exposure', parameters: {
...
/// 실험 그룹 Provider
final experimentGroupProvider =
    StateNotifierProvider<ExperimentGroupNotifier, Map<String, String>>((ref) {
