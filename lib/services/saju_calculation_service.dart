...
class SajuCalculationService {
  ...
  static Map<String, int> _analyzeElements(
    ...
    // 년주 오행
    elements[stemElements[year['stem']]!] = elements[stemElements[year['stem']]!]! + 1;
    elements[branchElements[year['branch']]!] = elements[branchElements[year['branch']]!]! + 1;
    
    // 월주 오행
    elements[stemElements[month['stem']]!] = elements[stemElements[month['stem']]!]! + 1;
    elements[branchElements[month['branch']]!] = elements[branchElements[month['branch']]!]! + 1;
    
    // 일주 오행
    elements[stemElements[day['stem']]!] = elements[stemElements[day['stem']]!]! + 1;
    elements[branchElements[day['branch']]!] = elements[branchElements[day['branch']]!]! + 1;
    
    // 시주 오행
    if (hour != null) {
      elements[stemElements[hour['stem']]!] = elements[stemElements[hour['stem']]!]! + 1;
      elements[branchElements[hour['branch']]!] = elements[branchElements[hour['branch']]!]! + 1;
    }
