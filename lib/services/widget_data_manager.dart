...
class WidgetDataManager {
  ...
  static Future<void> initialize() async {
    try {
      ...
      Logger.warning(
          '[WidgetDataManager] 위젯 데이터 매니저 초기화 실패 (선택적 기능, 위젯 데이터 비활성화): $e');
    }
  }
  ...
  static Future<void> updateDailyFortune(FortuneResponseModel fortune) async {
    try {
      ...
      Logger.warning(
          '[WidgetDataManager] 일일 운세 위젯 업데이트 실패 (선택적 기능, 위젯 비활성화): $e');
    }
  }
  ...
  static Future<void> updateLoveFortune(
    ...
    try {
      ...
      Logger.warning(
          '[WidgetDataManager] 사랑 운세 위젯 업데이트 실패 (선택적 기능, 위젯 비활성화): $e');
    }
  }
  ...
  static Future<void> clearAllWidgetData() async {
    try {
      ...
      Logger.warning(
          '[WidgetDataManager] 위젯 데이터 삭제 실패 (선택적 기능, 일부 데이터 유지됨): $e');
    }
  }
  ...
  static Future<void> _checkAndUpdateWidgets() async {
    try {
      ...
      Logger.warning(
          '[WidgetDataManager] 위젯 업데이트 확인 실패 (선택적 기능, 자동 업데이트 비활성화): $e');
    }
  }
  ...
  static Future<void> _loadAndUpdateWidgets() async {
    try {
      ...
      Logger.warning(
          '[WidgetDataManager] 위젯 데이터 로드 및 업데이트 실패 (선택적 기능, 위젯 비활성화): $e');
    }
  }

  /// Save fortune data to local storage
  static Future<void> _saveFortuneData(
      String key, FortuneResponseModel fortune) async {
    try {
      final prefs = await SharedPreferences.getInstance();
      await prefs.setString(
          key,
      ...
      Logger.warning(
          '[WidgetDataManager] 운세 데이터 저장 실패 (선택적 기능, 위젯 업데이트 안됨): $e');
    }
  }
  ...
  static Future<void> handleWidgetClick(Map<String, dynamic> params) async {
    try {
      ...
      Logger.warning(
          '[WidgetDataManager] 위젯 클릭 처리 실패 (선택적 기능, 앱 직접 실행 필요): $e');
    }
  }
}
