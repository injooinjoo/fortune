...
class OfflineIndicator extends ConsumerWidget {
  ...
  const OfflineIndicator(
      {super.key, required this.isOffline, this.lastSyncTime});
        ...
        child: Row(children: [
          ...
          Expanded(
              child: Column(
                  ...
                  children: [
                Text('오프라인 모드', style: Theme.of(context).textTheme.labelSmall),
                if (lastSyncTime != null) ...[
                  const SizedBox(height: AppSpacing.spacing1),
                  Text('동기화: ${_formatLastSync(lastSyncTime!)}',
                ...
                child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: AppSpacing.spacing2),
                          Text('캐시됨: ${_formatCachedTime(cachedAt)}',
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyMedium
                                  ?.copyWith(
