...
class UserInfoVisualization extends StatelessWidget {
  ...
  Widget _buildPersonSection(BuildContext context, String title,
      Map<String, dynamic> person, Color accentColor) {
    final theme = Theme.of(context);
            ...
            children: [
              ...
              if (person['birthDate'] != null) ...[
                ...
                _buildInfoItem(
                  ...
                  icon: Icons.pets,
                  label: '띠',
                  value: _getZodiacAnimal(
                      DateTime.parse(person['birthDate']).year),
                  color: accentColor,
                ),
              ],
            ],
  ...
  Widget _buildInfoItem(
    ...
    return Container(
      padding: const EdgeInsets.symmetric(
          horizontal: AppSpacing.spacing3, vertical: AppSpacing.spacing2),
      decoration: BoxDecoration(
