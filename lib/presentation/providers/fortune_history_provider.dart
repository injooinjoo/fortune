...
final fortuneHistoryProvider = StateNotifierProvider<FortuneHistoryNotifier, AsyncValue<List<FortuneHistory>>>((ref) {
  return FortuneHistoryNotifier();
});

class FortuneHistoryNotifier extends StateNotifier<AsyncValue<List<FortuneHistory>>> {
