...
class NavigationVisibilityState {
  ...
  const NavigationVisibilityState(
      {this.isVisible = true, this.isAnimating = false});

  NavigationVisibilityState copyWith({bool? isVisible, bool? isAnimating}) {
...
class NavigationVisibilityNotifier
    extends StateNotifier<NavigationVisibilityState> {
...
final navigationVisibilityProvider = StateNotifierProvider<
    NavigationVisibilityNotifier,
    NavigationVisibilityState>((ref) => NavigationVisibilityNotifier());
...
extension RouteNavigationVisibility on String {
  ...
  bool _isDeepRoute(String baseRoute) {
    ...
    final cleanPath = remainingPath.startsWith('/')
