...
final tokenHistoryProvider = FutureProvider.family<List<TokenTransaction>, int?>((ref, limit) async {
  final tokenDataSource = ref.watch(tokenRemoteDataSourceProvider);
...
final batchFortuneProvider = FutureProvider.family<Map<String, Fortune>, List<String>>((ref, types) async {
  final fortuneDataSource = ref.watch(fortuneRemoteDataSourceProvider);
...
final recentFortunesProvider = StateNotifierProvider<RecentFortunesNotifier, List<RecentFortune>>((ref) {
