...
class Fortune extends Equatable {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (overallScore != null) 'overallScore': null,
      if (description != null) 'description': null,
      if (scoreBreakdown != null) 'scoreBreakdown': null,
      if (luckyItems != null) 'luckyItems': null,
      if (recommendations != null) 'recommendations': null,
      if (warnings != null) 'warnings': null,
      if (summary != null) 'summary': null,
      if (additionalInfo != null) 'additionalInfo': null,
      if (detailedLuckyItems != null) 'detailedLuckyItems': null,
      if (greeting != null) 'greeting': null,
      if (hexagonScores != null) 'hexagonScores': null,
      if (timeSpecificFortunes != null) 'timeSpecificFortunes': null,
