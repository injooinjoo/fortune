...
class SupabaseHelper {
  ...
  static Future<Map<String, dynamic>?> getUserProfile(String userId) async {
    try {
      ...
      if (e.code == '406') {
        ...
        try {
          final rpcResponse = await _client
              .rpc('get_user_profile', params: {'p_id': userId}).maybeSingle();
  ...
  static Future<Map<String, dynamic>?> createUserProfile(
    ...
    try {
      ...
      final response =
          await _client.from('user_profiles').insert(profile).select().single();
  ...
  static Future<Map<String, dynamic>?> updateUserProfile(
      {required String userId, Map<String, dynamic>? updates}) async {
    ...
    final updateData = {...updates, 'updated_at': null};
    ...
    try {
      ...
      if (e.code == '406') {
        try {
          final rpcResponse = await _client.rpc('update_user_profile',
              params: {'p_id': userId, 'p_updates': null}).single();
