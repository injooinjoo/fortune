...
class AnimationDurations {
  ...
  static AnimationDurations lerp(
      AnimationDurations a, AnimationDurations b, double t) {
    return AnimationDurations(
        instant: Duration(
            milliseconds:
                lerpDouble(a.instant.inMilliseconds, b.instant.inMilliseconds, t)!
                    .round()),
        fast: Duration(
            milliseconds:
                lerpDouble(a.fast.inMilliseconds, b.fast.inMilliseconds, t)!
                    .round()),
        short: Duration(
            milliseconds:
        ...
        long: Duration(
            milliseconds:
                lerpDouble(a.long.inMilliseconds, b.long.inMilliseconds, t)!
                    .round()),
        veryLong: Duration(
            milliseconds:
                lerpDouble(a.veryLong.inMilliseconds, b.veryLong.inMilliseconds, t)!.round()),
