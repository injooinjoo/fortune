...
class FontSizeSystem {
  ...
  static const double displayLarge = 48.0;   // 가장 큰 헤드라인
  static const double displayMedium = 40.0;  // 큰 헤드라인
  static const double displaySmall = 32.0;   // 중간 헤드라인

  /// Heading Sizes (섹션 제목)
  /// 페이지 제목, 섹션 헤더에 사용
  static const double heading1 = 28.0;  // 메인 페이지 제목
  static const double heading2 = 24.0;  // 섹션 제목
  ...
  static const double numberXLarge = 40.0;  // 매우 큰 숫자
  static const double numberLarge = 32.0;   // 큰 숫자
  static const double numberMedium = 24.0;  // 중간 숫자
