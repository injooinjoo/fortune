...
class TarotMetadata {
  ...
  static const Map<int, TarotCardInfo> majorArcana = {
    0: TarotCardInfo(
      id: 0,
      name: '바보 (The Fool)',
      keywords: ['새로운 시작': '순수함': '자유', '모험': null,
