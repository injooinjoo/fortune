...
class TarotMetadata {
  ...
  static const Map<int, TarotCardInfo> majorArcana = {
    0: TarotCardInfo(
        ...
        questions: ['어떤 새로운 시작이 당신을 기다리고 있나요?', '무엇이 당신을 주저하게 만들고 있나요?'],
...
**흰 개**: 본능, 보호, 충실한 동반자''',
        ...
        healthMessage:
            '''신체적으로는 신경계와 관련이 있으며, 새로운 활력과 에너지를 나타냅니다. 정신적으로는 스트레스 해소와 마음의 개방성이 필요한 시기입니다. 새로운 운동이나 건강 습관을 시작하기 좋은 때입니다.''',
        cardCombinations: {
        ...
        historicalContext:
            '''바보 카드는 중세 유럽의 궁정 광대 전통과 깊은 연관이 있습니다. 광대는 왕에게 진실을 말할 수 있는 유일한 존재였으며, 그들의 '어리석음'은 오히려 지혜를 전달하는 수단이었습니다. 르네상스 시대에는 '신성한 광기'라는 개념이 유행했으며, 이는 바보 카드의 심오한 의미와 연결됩니다.''',
        artisticSymbolism:
            '''라이더-웨이트 덱에서 팸밀라 콜먼 스미스는 바보를 젊고 앤드로지너스한 인물로 그렸습니다. 이는 성별을 초월한 순수한 영혼을 나타냅니다. 절벽은 의식과 무의식의 경계를, 태양은 신성한 축복을 상징합니다. 작은 보따리는 과거의 경험을, 지팡이는 의지력을 나타냅니다.'''),
    1: TarotCardInfo(
        id: 1,
        ...
        questions: ['어떤 재능을 더 개발해야 하나요?', '목표 달성을 위해 무엇이 필요한가요?']),
    2: TarotCardInfo(
        id: 2,
        ...
        questions: ['무엇이 아직 드러나지 않았나요?', '내면의 목소리가 무엇을 말하고 있나요?']),
    3: TarotCardInfo(
        id: 3,
        ...
        questions: ['무엇을 창조하고 키워나가고 있나요?', '어떻게 자신을 더 사랑할 수 있나요?']),
    4: TarotCardInfo(
        id: 4,
        name: '황제 (The Emperor)',
        ...
        questions: ['어디서 더 많은 구조가 필요한가요?', '당신의 권위를 어떻게 사용하고 있나요?']),
    5: TarotCardInfo(
        id: 5,
        ...
        questions: ['어떤 믿음이 당신을 인도하고 있나요?', '누구에게서 배울 수 있나요?']),
    6: TarotCardInfo(
        id: 6,
        name: '연인들 (The Lovers)',
        ...
        questions: ['어떤 선택이 당신 앞에 놓여 있나요?', '무엇이 진정한 조화를 만드나요?']),
    7: TarotCardInfo(
        id: 7,
        name: '전차 (The Chariot)',
        ...
        questions: ['어떤 도전을 극복해야 하나요?', '어떻게 균형을 유지할 수 있나요?']),
    8: TarotCardInfo(
        id: 8,
        name: '힘 (Strength)',
        ...
        questions: ['어떤 내적 힘을 발견했나요?', '어디서 더 많은 인내가 필요한가요?']),
    9: TarotCardInfo(
        id: 9,
        name: '은둔자 (The Hermit)',
        ...
        questions: ['무엇을 찾고 있나요?', '혼자만의 시간이 왜 필요한가요?']),
    10: TarotCardInfo(
        id: 10,
        ...
        questions: ['어떤 변화가 다가오고 있나요?', '운명의 흐름을 어떻게 활용할 수 있나요?']),
    11: TarotCardInfo(
        id: 11,
        name: '정의 (Justice)',
        ...
        questions: ['어떤 결정이 필요한가요?', '무엇이 진정한 균형인가요?']),
    12: TarotCardInfo(
        id: 12,
        ...
        questions: ['무엇을 놓아주어야 하나요?', '어떤 새로운 관점이 필요한가요?']),
    13: TarotCardInfo(
        id: 13,
        name: '죽음 (Death)',
        ...
        questions: ['무엇을 끝내야 하나요?', '어떤 변화가 필요한가요?']),
    14: TarotCardInfo(
        id: 14,
        name: '절제 (Temperance)',
        ...
        questions: ['어디서 더 많은 균형이 필요한가요?', '무엇을 통합해야 하나요?']),
    15: TarotCardInfo(
        id: 15,
        name: '악마 (The Devil)',
        ...
        questions: ['무엇이 당신을 속박하고 있나요?', '어떤 두려움과 마주해야 하나요?']),
    16: TarotCardInfo(
        id: 16,
        name: '탑 (The Tower)',
        ...
        questions: ['어떤 구조가 무너져야 하나요?', '진실은 무엇인가요?']),
    17: TarotCardInfo(
        id: 17,
        name: '별 (The Star)',
        ...
        questions: ['무엇이 당신에게 희망을 주나요?', '어떤 꿈을 향해 나아가고 있나요?']),
    18: TarotCardInfo(
        id: 18,
        name: '달 (The Moon)',
        ...
        questions: ['무엇이 숨겨져 있나요?', '어떤 두려움이 당신을 지배하나요?']),
    19: TarotCardInfo(
        id: 19,
        name: '태양 (The Sun)',
        ...
        questions: ['무엇이 당신을 행복하게 하나요?', '어떤 성공을 축하해야 하나요?']),
    20: TarotCardInfo(
        id: 20,
        name: '심판 (Judgement)',
        ...
        questions: ['무엇을 용서해야 하나요?', '어떤 부름을 받고 있나요?']),
    21: TarotCardInfo(
        id: 21,
        name: '세계 (The World)',
        ...
        questions: ['무엇을 완성했나요?', '다음 여정은 무엇인가요?']),
  };
  ...
  static const Map<String, TarotSpread> spreads = {
    ...
    'career': TarotSpread(
        ...
        cardCount: 5,
        positions: ['현재 직업 상황', '숨겨진 영향', '조언', '예상되는 도전', '잠재적 결과'],
