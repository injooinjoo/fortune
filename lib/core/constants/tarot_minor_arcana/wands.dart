...
class TarotWands {
  static const Map<String, TarotCardInfo> cards = {
    'wands_ace': TarotCardInfo(
        ...
        questions: ['어떤 새로운 열정이 당신을 기다리고 있나요?', '당신의 창의적 에너지를 어디에 집중할 것인가요?']),
    'wands_2': TarotCardInfo(
        ...
        questions: ['당신의 장기적인 목표는 무엇인가요?', '어떤 선택이 더 나은 미래로 이끌까요?']),
    'wands_3': TarotCardInfo(
        ...
        questions: ['어떤 기회가 지평선 너머에 있나요?', '당신의 비전을 어떻게 확장할 수 있나요?']),
    'wands_4': TarotCardInfo(
        ...
        questions: ['무엇을 축하해야 하나요?', '어떻게 더 안정적인 기반을 만들 수 있나요?']),
    'wands_5': TarotCardInfo(
        ...
        questions: ['어떤 갈등이 성장의 기회가 될 수 있나요?', '경쟁이 당신을 어떻게 발전시키고 있나요?']),
    'wands_6': TarotCardInfo(
        ...
        questions: ['어떤 성공을 축하해야 하나요?', '인정받기 위해 무엇을 해야 하나요?']),
    'wands_7': TarotCardInfo(
        ...
        questions: ['무엇을 지켜야 하나요?', '어떤 도전이 당신을 더 강하게 만들고 있나요?']),
    'wands_8': TarotCardInfo(
        ...
        questions: ['어떤 일이 빠르게 진행되고 있나요?', '기다리던 소식이 무엇인가요?']),
    'wands_9': TarotCardInfo(
        ...
        questions: ['무엇이 당신을 계속 나아가게 하나요?', '어떤 교훈을 배웠나요?']),
    'wands_10': TarotCardInfo(
        ...
        questions: ['어떤 부담을 내려놓아야 하나요?', '책임을 어떻게 분담할 수 있나요?']),
    'wands_page': TarotCardInfo(
        ...
        questions: ['어떤 새로운 열정이 당신을 부르고 있나요?', '창의적인 에너지를 어디에 쏟을 것인가요?']),
    'wands_knight': TarotCardInfo(
        ...
        questions: ['어디로 모험을 떠나고 싶나요?', '충동을 어떻게 건설적으로 활용할 수 있나요?']),
    ...
    'wands_king': TarotCardInfo(
        ...
        questions: ['당신의 비전은 무엇인가요?', '어떻게 더 나은 리더가 될 수 있나요?']),
  };
