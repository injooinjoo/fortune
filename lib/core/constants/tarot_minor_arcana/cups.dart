...
class TarotCups {
  static const Map<String, TarotCardInfo> cards = {
    'cups_ace': TarotCardInfo(
        ...
        questions: ['어떤 새로운 감정이 당신을 기다리고 있나요?', '마음을 어디에 열어야 하나요?']),
    'cups_2': TarotCardInfo(
        ...
        questions: ['어떤 관계가 당신에게 중요한가요?', '어떻게 더 깊은 연결을 만들 수 있나요?']),
    'cups_3': TarotCardInfo(
        ...
        questions: ['누구와 기쁨을 나누고 싶나요?', '어떤 성취를 축하해야 하나요?']),
    'cups_4': TarotCardInfo(
        ...
        questions: ['어떤 기회를 놓치고 있나요?', '무엇이 당신을 만족시킬 수 있나요?']),
    'cups_5': TarotCardInfo(
        ...
        questions: ['무엇을 놓아주어야 하나요?', '어떻게 상실을 성장의 기회로 만들 수 있나요?']),
    'cups_6': TarotCardInfo(
        ...
        questions: ['어떤 어린 시절의 기쁨을 되찾을 수 있나요?', '과거가 현재에 어떤 영향을 미치고 있나요?']),
    'cups_7': TarotCardInfo(
        ...
        questions: ['어떤 환상이 당신을 현혹하고 있나요?', '진정으로 원하는 것은 무엇인가요?']),
    'cups_8': TarotCardInfo(
        ...
        questions: ['무엇을 뒤로하고 떠나야 하나요?', '더 깊은 의미를 어디서 찾을 수 있나요?']),
    'cups_9': TarotCardInfo(
        ...
        questions: ['무엇이 당신을 진정으로 행복하게 하나요?', '어떤 소원이 이루어졌나요?']),
    'cups_10': TarotCardInfo(
        ...
        questions: ['진정한 행복은 어디에서 오나요?', '어떻게 더 조화로운 관계를 만들 수 있나요?']),
    'cups_page': TarotCardInfo(
        ...
        questions: ['어떤 창의적 메시지가 당신에게 오고 있나요?', '직관이 무엇을 말하고 있나요?']),
    'cups_knight': TarotCardInfo(
        ...
        questions: ['어떤 로맨틱한 기회가 다가오고 있나요?', '감정과 행동의 균형을 어떻게 맞출 수 있나요?']),
    'cups_queen': TarotCardInfo(
        ...
        questions: ['어떻게 더 감정적으로 성숙해질 수 있나요?', '누가 당신의 동정심을 필요로 하나요?']),
    'cups_king': TarotCardInfo(
        ...
        questions: ['어떻게 감정과 이성의 균형을 맞출 수 있나요?', '당신의 감정적 지혜를 어떻게 활용할 수 있나요?']),
  };
