...
class TarotDeckMetadata {
  ...
  static const Map<String, TarotDeck> availableDecks = {
    'rider_waite': TarotDeck(
        ...
        description:
            '가장 인기 있고 널리 사용되는 타로 카드로, 1909년 Arthur Edward Waite와 Pamela Colman Smith가 만들었습니다.',
        characteristics: [
          '직관적이고 상징적인 이미지',
          '초보자에게 적합한 명확한 상징',
    ...
    'thoth': TarotDeck(
        ...
        koreanName: '토트 타로',
        description:
            'Aleister Crowley가 디자인하고 Lady Frieda Harris가 그린 신비주의적이고 복잡한 타로 카드입니다.',
        characteristics: [
          '깊은 상징과 신비주의적 요소',
          '카발라와 점성술 통합',
          '추상적이고 복잡한 이미지',
    ...
    'before_tarot': TarotDeck(
        ...
        characteristics: ['시간적 내러티브 강조', '원인과 결과 탐구', '스토리텔링에 적합', '독특한 관점 제공'],
    ...
    'after_tarot': TarotDeck(
        ...
        characteristics: ['결과와 영향 탐구', '시간의 흐름 표현', '깊이 있는 내러티브', '확장된 의미 해석'],
    ...
    'golden_dawn_cicero': TarotDeck(
        ...
        description:
            'Hermetic Order of the Golden Dawn의 전통을 따르는 정통 신비주의 타로 카드입니다.',
        characteristics: ['황금새벽회 전통', '카발라와 연금술 상징', '플래싱 컬러 사용', '의식 마법에 적합'],
    ...
    'golden_dawn_wang': TarotDeck(
        ...
        description:
            'Israel Regardie의 감독 하에 제작된 Golden Dawn의 비밀 구전 전통을 담은 타로입니다.',
        characteristics: ['비밀 구전 전통', '순수한 상징 체계', '교육적 목적', '역사적 중요성'],
    ...
    'grand_etteilla': TarotDeck(
        ...
        koreanName: '그랑 에테이야',
        description:
            '최초로 점술 목적으로 디자인된 역사적인 타로 카드로, 1785년 Jean-Baptiste Alliette가 만들었습니다.',
        characteristics: [
          '최초의 점술 전용 타로',
          '카드에 의미가 직접 쓰여 있음',
          '정방향/역방향 의미 표시',
  ...
  static List<TarotDeck> getDecksForStyle(TarotStyle style) {
    return availableDecks.values.where((deck) => deck.style == style).toList();
  }
}
