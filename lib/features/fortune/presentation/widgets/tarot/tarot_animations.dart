...
class TarotAnimations {
  ...
  static Animation<double> createFlipAnimation(AnimationController controller) {
    return Tween<double>(begin: 0.0, end: 1.0)
        .animate(CurvedAnimation(parent: controller, curve: cardFlipCurve));
  }
  ...
  static List<Animation<double>> createFanAnimations(
    ...
    return List.generate(cardCount, (index) {
      ...
      return Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
          parent: controller,
          curve: Interval(
              delay * delayFactor, delayFactor + delay * (1 - delayFactor),
  ...
  static FanSpreadPosition calculateFanPosition(
    ...
    debugPrint(
        '[TarotAnim] angle: $angle (fanAngle: $fanAngle, baseRotation: $baseRotation)');
  ...
  static Animation<double> createFloatAnimation(
    ...
    return Tween<double>(begin: -5.0, end: 5.0)
  ...
  static Animation<double> createShuffleAnimation(
      AnimationController controller) {
