                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: RadialGradient(
                            colors: [
                              TossDesignSystem.purple.withValues(alpha: 0.3 * _glowAnimation.value),
          ...
          children: [
            ...
            GlassContainer(
              gradient: LinearGradient(
                colors: isFlipped
                    ? [TossDesignSystem.purple, TossDesignSystem.purple]
                    : [TossDesignSystem.purple.withValues(alpha: 0.92), TossDesignSystem.purple.withValues(alpha: 0.92)],
