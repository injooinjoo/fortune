...
class SajuChartTemplate extends StatelessWidget {
  ...
  Widget _buildElementsChart(BuildContext context) {
    final elementColors = {
      '목': DSColors.success, // Wood - green
      '화': DSColors.error, // Fire - red
      '토': DSColors.warning, // Earth - yellow
      '금': DSColors.surface, // Metal - white/light
      '수': DSColors.info, // Water - blue
    };
...
class _SajuPillarWidget extends StatelessWidget {
  ...
  Color _getElementColor(String? element) {
    switch (element) {
      ...
      case '토':
        return DSColors.warning; // Earth - yellow
      case '금':
        return DSColors.surface; // Metal - white/light
      case '수':
      ...
      child: Column(
        ...
        children: [
          ...
          _BiorhythmBar(
            ...
            data: emotional,
            color: DSColors.accentSecondary, // 감정 리듬 - 핑크
          ),
          const SizedBox(height: DSSpacing.md),
          _BiorhythmBar(
            label: '지성',
