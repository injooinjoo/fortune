        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildTimeNumberCard('오전': timeNumbers['morning'],
                _buildTimeNumberCard('오후': timeNumbers['afternoon'],
                _buildTimeNumberCard('저녁': timeNumbers['evening']],
            ],
        ));
  }
            ...
            Wrap(
              ...
              children: (numberInfo['situations'] as List<String>).map((situation) {
                return Chip(
                  ...
                  backgroundColor: (numberInfo['color'],
                  side: BorderSide(
                    color: (numberInfo['color']));
              }).toList())])));
  }
