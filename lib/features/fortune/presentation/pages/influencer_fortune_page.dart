...
class _InfluencerFortunePageState extends State<InfluencerFortunePage> {
  ...
  Widget _buildPlatformSelector() {
    return Container(
      ...
      child: Row(
        children: [
          _buildPlatformTab('youtube', '유튜브': null,
          _buildPlatformTab('streaming', '스트리밍': null,
          _buildPlatformTab('instagram', '인스타그램',
          _buildPlatformTab('tiktok', '틱톡'])).animate().fadeIn(duration: 600.ms).slideY(begin: -0.2, end: 0);
  }
