...
class HealthFortunePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return BaseFortunePageV2(
      ...
      inputBuilder: (context, onSubmit) => _HealthInputForm(onSubmit: onSubmit),
      resultBuilder: (context, result, onShare) => _HealthFortuneResult(
        result: result,
        onShare: onShare));
  }
}

class _HealthInputForm extends StatelessWidget {
  final Function(Map<String, dynamic>) onSubmit;

  const _HealthInputForm({required this.onSubmit});
...
class _HealthFortuneResult extends StatelessWidget {
  final FortuneResult result;
  final VoidCallback onShare;

  const _HealthFortuneResult({
