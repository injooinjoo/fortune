...
class _BirthdateFortunePageState extends ConsumerState<BirthdateFortunePage> {
  ...
  final Map<int, Map<String, dynamic>> weekdayMeanings = {
    1: {
      ...
      'planet': '달',
      'element': '물',
      'characteristics': ['감성적': '직관적': '배려심', '창의적'],
      'color': Colors.blue,
      'gemstone': '진주',
    },
    2: {
      ...
      'planet': '화성',
      'element': '불',
      'characteristics': ['열정적', '도전적', '리더십', '용기'],
      'color': Colors.red,
      'gemstone': '루비',
    },
    3: {
      ...
      'planet': '수성',
      'element': '공기',
      'characteristics': ['지적', '소통', '적응력', '다재다능'],
      'color': Colors.green,
      'gemstone': '에메랄드',
    },
    4: {
    ...
    5: {
      ...
      'planet': '금성',
      'element': '금속',
      'characteristics': ['예술적', '조화', '사랑', '아름다움'],
      'color': Colors.pink,
      'gemstone': '다이아몬드',
    },
    6: {
      ...
      'planet': '토성',
      'element': '흙',
      'characteristics': ['책임감', '인내심', '실용적', '안정'],
      'color': Colors.brown,
      'gemstone': '흑요석',
    },
    7: {
      ...
      'planet': '태양',
      'element': '빛',
      'characteristics': ['활력', '자신감', '창조성', '카리스마'],
      'color': Colors.orange,
      'gemstone': '토파즈',
    },
  };
  ...
  final Map<int, Map<String, String>> lifePathMeanings = {
    1: {
      'title': '개척자',
      'description': '독립적이고 창의적인 리더십을 가진 사람',
      'strength': '독창성, 결단력, 추진력',
      'weakness': '고집, 이기심, 성급함',
      'advice': '타인의 의견을 경청하고 협력하는 자세를 기르세요',
    },
    2: {
      'title': '조화로운 협력자',
      'description': '평화를 사랑하고 타인과의 조화를 중시하는 사람',
      'strength': '협동심, 외교력, 섬세함',
      'weakness': '우유부단, 의존성, 소극성',
      'advice': '자신감을 가지고 주도적으로 행동하세요',
    },
    3: {
      'title': '창의적 표현가',
      'description': '예술적 감각과 표현력이 뛰어난 사람',
      'strength': '창의성, 소통능력, 낙천성',
      'weakness': '산만함, 과장, 변덕',
      'advice': '집중력을 기르고 끈기 있게 노력하세요',
    },
    4: {
      'title': '실용적 건설자',
      'description': '체계적이고 실용적인 접근을 하는 사람',
      'strength': '성실성, 신뢰성, 조직력',
      'weakness': '융통성 부족, 완고함, 비관주의',
      'advice': '변화를 받아들이고 유연한 사고를 가지세요',
    },
    5: {
      'title': '자유로운 모험가',
      'description': '변화와 자유를 추구하는 역동적인 사람',
      'strength': '적응력, 호기심, 다재다능',
      'weakness': '무책임, 충동성, 불안정',
      'advice': '책임감을 가지고 한 가지에 집중하세요',
    },
    6: {
      'title': '헌신적 봉사자',
      'description': '가족과 공동체를 위해 헌신하는 사람',
      'strength': '책임감, 사랑, 봉사정신',
      'weakness': '간섭, 걱정, 자기희생',
      'advice': '자신을 먼저 돌보고 균형을 찾으세요',
    },
    7: {
      'title': '영적 탐구자',
      'description': '내면의 지혜와 영적 성장을 추구하는 사람',
      'strength': '직관력, 분석력, 영성',
      'weakness': '고립, 비판적, 은둔',
      'advice': '타인과 소통하고 현실과 균형을 맞추세요',
    },
    8: {
      'title': '물질적 성취자',
      'description': '목표 달성과 물질적 성공을 추구하는 사람',
      'strength': '야망, 조직력, 판단력',
      'weakness': '물질주의, 권위주의, 냉정함',
      'advice': '영적 가치를 인정하고 나눔을 실천하세요',
    },
    9: {
      'title': '인류애적 봉사자',
      'description': '인류 전체를 위한 큰 뜻을 품은 사람',
      'strength': '이타심, 지혜, 이해심',
      'weakness': '이상주의, 감정기복, 분산',
      'advice': '현실적 목표를 세우고 자기관리에 힘쓰세요',
    },
    11: {
      'title': '영감의 메신저',
      'description': '높은 직관력과 영감을 가진 특별한 사람',
      'strength': '영감, 이상주의, 카리스마',
      'weakness': '신경과민, 자기의심, 긴장',
      'advice': '내면의 평화를 찾고 실천에 옮기세요',
    },
    22: {
      'title': '마스터 빌더',
      'description': '큰 비전을 현실로 만드는 능력을 가진 사람',
      'strength': '비전, 실행력, 리더십',
      'weakness': '압박감, 완벽주의, 고립',
      'advice': '작은 성취도 인정하고 과정을 즐기세요',
    },
    33: {
      'title': '마스터 티처',
      'description': '사랑과 봉사로 세상을 가르치는 사람',
      'strength': '무조건적 사랑, 치유력, 영적 지도력',
      'weakness': '자기희생, 부담감, 이상과 현실의 괴리',
      'advice': '자신의 한계를 인정하고 휴식을 취하세요',
    },
  };
            ...
            children: [
              ...
              Wrap(
                ...
                children: (weekdayInfo['characteristics'] as List<String>)
                    .map((trait) => Chip(
                          label: Text(trait),
                          backgroundColor: (weekdayInfo['color'],
                        ))
                    .toList(),
              ),
              const SizedBox(height: 16),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildAnalysisRow('강점': lifePathInfo['strength'],
              const SizedBox(height: 12,
              _buildAnalysisRow('약점': lifePathInfo['weakness'],
              const SizedBox(height: 16,
              Container(
