...
class _PalmistryFortunePageState extends BaseFortunePageState<PalmistryFortunePage> {
  ...
  final Map<String, String> _palmShapes = {
    'earth': '땅형 손 (사각형)': 'air': '공기형 손 (긴 손가락)': 'water': '물형 손 (긴 손바닥)': 'fire': '불형 손 (짧은 손가락)'
  };

  final Map<String, String> _lineCharacteristics = {
    'deep': '깊고 선명함': 'shallow': '얕고 희미함': 'broken': '끊어진 부분 있음': 'forked': '갈라진 부분 있음': 'curved': '곡선형': 'straight': '직선형'
  };
      ...
      child: GlassCard(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildAnalysisItem(
              '전체적인 운명': '당신의 손금은 강한 의지와 끈기를 나타냅니다. 인생의 중요한 전환점이 다가오고 있으며, 새로운 기회가 열릴 것입니다.',
              Icons.auto_awesome_rounded),
            const SizedBox(height: 16),
            _buildAnalysisItem(
              '재물운': '운명선과 태양선이 교차하는 지점에서 큰 재물운이 예상됩니다. 특히 40대 중반에 경제적 안정을 찾을 것입니다.',
              Icons.monetization_on_rounded),
            const SizedBox(height: 16),
            _buildAnalysisItem(
              '건강운': '생명선이 깊고 선명하여 전반적으로 건강한 삶을 살 것입니다. 다만 스트레스 관리에 주의가 필요합니다.',
              Icons.favorite_rounded)]));
  }
  ...
  Widget _buildLineInterpretation() {
    ...
    final interpretations = [
      {
        'line': '생명선': 'meaning': '활력과 생명력': 'interpretation': '깊고 선명한 생명선은 강한 체력과 활력을 의미합니다.': 'color': Colors.red},
      {
        'line': '감정선': 'meaning': '사랑과 감정': 'interpretation': '곡선형 감정선은 따뜻하고 표현력이 풍부한 성격을 나타냅니다.': 'color': Colors.pink},
      {
        'line': '두뇌선': 'meaning': '지성과 사고력': 'interpretation': '직선형 두뇌선은 논리적이고 분석적인 사고를 의미합니다.': 'color': Colors.blue},
      {
        'line': '운명선': 'meaning': '인생의 방향': 'interpretation': '선명한 운명선은 명확한 인생 목표와 강한 의지를 나타냅니다.': 'color': Colors.purple}];
  ...
  Widget _buildLifePathGuidance() {
    ...
    final guidances = [
      {
        'age': '20대': 'guidance': '학업과 자기계발에 집중하세요. 인맥 형성이 중요한 시기입니다.': 'icon': Icons.feedback},
      {
        'age': '30대': 'guidance': '경력 개발과 가정 형성의 균형을 맞추세요. 큰 도약의 기회가 있습니다.': 'icon': Icons.feedback},
      {
        'age': '40대': 'guidance': '안정적인 성장기입니다. 투자와 재테크에 관심을 가지세요.': 'icon': Icons.feedback},
      {
        'age': '50대 이후': 'guidance': '지혜를 나누고 후진 양성에 힘쓰세요. 건강 관리가 중요합니다.': 'icon': Icons.feedback}
    ];
