...
class _BirthstoneFortunePageState extends ConsumerState<BirthstoneFortunePage> {
  ...
  final Map<int, Map<String, dynamic>> birthstones = {
    1: {
      ...
      'element': '불',
      'planet': '화성',
      'healing': '혈액순환 개선, 에너지 증진': 'icon': Icons.feedback},
    },
    2: {
      'name': '자수정',
      ...
      'element': '공기',
      'planet': '목성',
      'healing': '불면증 개선, 두통 완화', 'icon': Icons.feedback},
    },
    3: {
      'name': '아쿠아마린',
      ...
      'element': '물',
      'planet': '해왕성',
      'healing': '목 건강, 알레르기 완화', 'icon': Icons.feedback},
    },
    4: {
      'name': '다이아몬드',
      'englishName': 'Diamond',
      ...
      'element': '빛',
      'planet': '금성',
      'healing': '뇌 기능 향상, 해독 작용', 'icon': Icons.feedback},
    },
    5: {
      'name': '에메랄드',
      'englishName': 'Emerald',
      ...
      'element': '흙',
      'planet': '수성',
      'healing': '시력 보호, 심장 건강', 'icon': Icons.feedback},
    },
    6: {
      'name': '진주',
      'englishName': 'Pearl',
      ...
      'element': '물',
      'planet': '달',
      'healing': '소화 개선, 피부 건강', 'icon': Icons.feedback},
    },
    7: {
      'name': '루비',
      'englishName': 'Ruby',
      ...
      'element': '불',
      'planet': '태양',
      'healing': '혈액순환, 활력 증진', 'icon': Icons.feedback},
    },
    8: {
      'name': '페리도트',
      'englishName': 'Peridot',
      ...
      'element': '흙',
      'planet': '금성',
      'healing': '소화기 건강, 면역력 강화', 'icon': Icons.feedback},
    },
    9: {
      'name': '사파이어',
      ...
      'element': '공기',
      'planet': '토성',
      'healing': '시력 개선, 정신 안정', 'icon': Icons.feedback},
    },
    10: {
      'name': '오팔',
      'englishName': 'Opal',
      ...
      'benefits': ['창의력 증진': '감정 표현', '변화 수용', '영감 획득'],
      'chakra': '모든 차크라',
      'element': '모든 원소',
      'planet': '수성',
      'healing': '감정 치유, 면역력 강화', 'icon': Icons.feedback},
    },
    11: {
      'name': '토파즈',
      'englishName': 'Topaz',
      ...
      'element': '불',
      'planet': '목성',
      'healing': '소화 개선, 신진대사 활성화', 'icon': Icons.feedback},
    },
    12: {
      'name': '터키석',
      ...
      'element': '공기와 물',
      'planet': '금성',
      'healing': '해독 작용, 면역력 강화', 'icon', Icons.feedback},
    },
  };
    ...
    Color
          ...
          if (_selectedMonth != null) ...[
            Container(
              ...
              decoration: BoxDecoration(
                color: (birthstones[_selectedMonth]!['color'],
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: (birthstones[_selectedMonth]!['color'],
                ),
              ...
              child: Row(
                children: [
                  Icon(
                    birthstones[_selectedMonth]!['icon'],
                    size: 48,
                    color: birthstones[_selectedMonth]!['color'],
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          birthstones[_selectedMonth]!['name'],
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                          ),
                        ...
                        Text(
                          birthstones[_selectedMonth]!['englishName'],
                          style: TextStyle(
                            fontSize: 14,
                        ...
                        Text(
                          birthstones[_selectedMonth]!['meaning'],
                          style: TextStyle(
                            fontSize: 14,
                            color: birthstones[_selectedMonth]!['color'],
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: _selectedMonth != null
                    ? birthstones[_selectedMonth]!['color'],
    Color
                    : Colors.grey,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.auto_awesome, color: birthstone['color'],
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 16),
              _buildInfoRow('차크라': birthstone['chakra'],
              _buildInfoRow('원소': birthstone['element'],
              _buildInfoRow('지배 행성': birthstone['planet'],
              _buildInfoRow('치유 효과': birthstone['healing'],
            ],
          ,
        ,
