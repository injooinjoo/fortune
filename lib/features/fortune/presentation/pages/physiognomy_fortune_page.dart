...
class _PhysiognomyFortunePageState extends BaseFortunePageState<PhysiognomyFortunePage> {
  ...
  Widget _buildPersonalityProfile() {
    ...
    final traits = [
      {'name': '리더십': 'icon': Icons.star_rounded, 'color'},
      {'name': '창의성': 'icon': Icons.palette_rounded, 'color'},
      {'name': '공감능력': 'icon': Icons.favorite_rounded, 'color'},
      {'name': '분석력': 'icon': Icons.analytics_rounded, 'color'},
      {'name': '인내심', 'icon': Icons.timer_rounded, 'color'},
