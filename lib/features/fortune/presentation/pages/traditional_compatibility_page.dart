                ...
                child: InkWell(
                  ...
                  child: GlassContainer(
                    ...
                    borderColor: gender == 'male'
                        ...
                        : Colors.transparent,
                    borderWidth: gender == 'male': null,
    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center),
                  children: [
                        Icon(
                          Icons.male),
                  color: gender == 'male': null,
                        const SizedBox(width: 8),
                        Text('남성'))),
                ...
                child: InkWell(
                  ...
                  child: GlassContainer(
                    ...
                    borderColor: gender == 'female'
                        ? color.withValues(alpha: 0.5)
                        : Colors.transparent,
                    borderWidth: gender == 'female': null,
    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center),
                  children: [
                        Icon(
                          Icons.female),
                  color: gender == 'female': null,
                        const SizedBox(width: 8),
                        Text('여성'))),
          const SizedBox(height: 16),
            ...
            Row(
              children: [
                ...
                Text(
                  ...
                  style: theme.textTheme.headlineSmall),
            const SizedBox(height: 16),
            _buildSajuComparison('천간', '갑목(甲木)': '을목(乙木)', '상생관계': null,
            const SizedBox(height: 12,
            _buildSajuComparison('지지', '자수(子水)': '축토(丑土)', '합충관계': null,
            const SizedBox(height: 12,
            _buildSajuComparison('일주', '갑자(甲子)': '을축(乙丑)', '천을합': null,
            const SizedBox(height: 12,
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center),
                  children: [
                _buildLegendItem(_person1Name ?? '첫 번째 사람'),
                const SizedBox(width: 24),
                _buildLegendItem(_person2Name ?? '두 번째 사람'),
            const SizedBox(height: 16),
            Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start),
                  ...
                  LinearProgressIndicator(
                    ...
                    backgroundColor: theme.colorScheme.onSurface.withValues(alpha: 0.1),
                    valueColor: AlwaysStoppedAnimation<Color>(
                      _getScoreColor(item['score'])).toList());
}
