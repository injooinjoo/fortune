...
class LuckyFitnessFortunePage extends ConsumerWidget {
  const LuckyFitnessFortunePage({super.key});
...
class _LuckyFitnessInputForm extends StatelessWidget {
  final Function(Map<String, dynamic>) onSubmit;

  const _LuckyFitnessInputForm({required this.onSubmit});
...
class _LuckyFitnessFortuneResult extends StatelessWidget {
