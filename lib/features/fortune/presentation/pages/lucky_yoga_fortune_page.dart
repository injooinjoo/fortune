...
class LuckyYogaFortunePage extends ConsumerWidget {
  const LuckyYogaFortunePage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return BaseFortunePageV2(
      ...
      inputBuilder: (context, onSubmit) => _LuckyYogaInputForm(onSubmit: onSubmit),
...
class _LuckyYogaInputForm extends StatelessWidget {
  final Function(Map<String, dynamic>) onSubmit;

  const _LuckyYogaInputForm({required this.onSubmit});
...
class _LuckyYogaFortuneResult extends StatelessWidget {
  final FortuneResult result;
  final VoidCallback onShare;

  const _LuckyYogaFortuneResult({
