...
class _NetworkReportResultState extends ConsumerState<_NetworkReportResult> {
  ...
  List<RadarEntry> _getRadarDataEntries(Map<String, dynamic> chartData) {
    return [
      RadarEntry(value: (chartData['depth'],
      RadarEntry(value: (chartData['diversity'],
      RadarEntry(value: (chartData['trust'],
      RadarEntry(value: (chartData['activity'],
      RadarEntry(value: (chartData['growth']];
  }
