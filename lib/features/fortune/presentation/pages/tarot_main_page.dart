...
class _TarotMainPageState extends ConsumerState<TarotMainPage>
    ...
    left: animatedLeft,
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    // Calculate positions
                    // Initial,
    position: below header and subtitle with proper spacing
  ...
  Widget _buildMainCard(String dateString) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        // print('value: ${_cardScaleAnimation.value}'));
        // print('value: ${_cardRotationAnimation.value}'));
        // print('value: ${_cardExpansionSizeAnimation.value}'));
        // print('value: ${_cardRadiusAnimation.value}'));
  ...
  Widget _buildCardDetail() {
    ...
    // Standard card size (tarot card ratio,
    1: 1.4,
  ...
  String _getThemeSpecificInterpretation(TarotCardInfo cardInfo) {
    switch (_selectedCardType) {
      case 'daily':
        return "오늘의,
    운세: ${cardInfo.dailyApplications?.join(' ') ?? cardInfo.uprightMeaning}";
      case 'love':
      ...
      case 'choice':
        return "선택의,
    순간: 이 카드가 제시하는 방향은 ${cardInfo.advice}";
      case 'health':
