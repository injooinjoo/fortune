...
class FortuneCategory {
  ...
  static Color _parseColor(String hex) {
    try {
      ...
      return DSFortuneColors.categoryDaily; // 기본색
    }
  }
...
const List<FortuneCategory> _defaultCategories = [
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryDaily, DSFortuneColors.categoryExam],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryTraditional, DSFortuneColors.categoryLove],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryTarot, DSFortuneColors.categoryTalisman],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryDream, DSFortuneColors.categoryMbti],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryTraditional, DSFortuneColors.categoryAvoidPeople],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryLotto, Color(0xFFD97706)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryMbti, DSFortuneColors.categoryLove],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryDaily, Color(0xFF5B21B6)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryLove, Color(0xFFDB2777)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryBlindDate, DSFortuneColors.categoryTarot],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryAvoidPeople, Color(0xFFB91C1C)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryExLover, Color(0xFF374151)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryCoaching, DSFortuneColors.celebrityActor],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryCareer, Color(0xFF1D4ED8)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryMoney, Color(0xFF15803D)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryTalisman, DSFortuneColors.categoryExam],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryTalent, Color(0xFFFF8F00)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryWish, Color(0xFFF50057)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryHealth, DSFortuneColors.categoryMoving],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryExam, DSFortuneColors.categoryCareer],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryExercise, DSFortuneColors.categoryAvoidPeople],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryDream, Color(0xFF4F46E5)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryFortuneCookie, DSFortuneColors.categoryTalisman],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryCelebrity, DSFortuneColors.celebrityActor],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryPet, Color(0xFFBE123C)],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryFamily, DSFortuneColors.categoryCareer],
  ...
  FortuneCategory(
    ...
    gradientColors: [DSFortuneColors.categoryNaming, DSFortuneColors.categoryTalisman],
