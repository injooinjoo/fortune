...
enum TalismanType {
  ...
  wealth('재물부적': '재물운과 금전운을 상승시키는 부적',
  love('연애부적': '사랑과 인연을 불러오는 부적',
  health('건강부적': '건강과 장수를 기원하는 부적',
  protection('액막이부적': '나쁜 기운과 액운을 막아주는 부적',
  success('성공부적': '목표 달성과 성공을 돕는 부적',
  study('학업부적': '학업 성취와 합격을 기원하는 부적',
  business('사업부적': '사업 번창과 번영을 기원하는 부적',
  family('가정화목부적': '가족의 화목과 평안을 지키는 부적',
