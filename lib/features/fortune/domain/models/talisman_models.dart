...
/// 부적 타입 정의
enum TalismanType {
  wealth('재물부적', '재물운과 금전운을 상승시키는 부적', Icons.monetization_on_rounded, [Color(0xFFFFD700), Color(0xFFFFB300)]),
  love('연애부적', '사랑과 인연을 불러오는 부적', Icons.favorite_rounded, [Color(0xFFEC4899), Color(0xFFDB2777)]),
  health('건강부적', '건강과 장수를 기원하는 부적', Icons.favorite_border_rounded, [Color(0xFF10B981), Color(0xFF059669)]),
  protection('액막이부적', '나쁜 기운과 액운을 막아주는 부적', Icons.shield_rounded, [Color(0xFF6B7280), Color(0xFF4B5563)]),
  success('성공부적', '목표 달성과 성공을 돕는 부적', Icons.star_rounded, [Color(0xFFF59E0B), Color(0xFFEA580C)]),
  study('학업부적', '학업 성취와 합격을 기원하는 부적', Icons.school_rounded, [Color(0xFF3B82F6), Color(0xFF2563EB)]),
  business('사업부적', '사업 번창과 번영을 기원하는 부적', Icons.business_rounded, [Color(0xFF7C3AED), Color(0xFF6D28D9)]),
