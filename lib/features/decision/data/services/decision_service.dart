...
class DecisionService {
            ...
            body: {
              ...
              'data': {
                ...
                if (optionsAnalyzed != null)
                  'optionsAnalyzed': optionsAnalyzed.map((e) => e.toJson()).toList(),
  ...
  Future<UserCoachPreferences> getPreferences({required String userId}) async {
    try {
      ...
      return UserCoachPreferences.fromJson(data['data'] as Map<String, dynamic>);
    } catch (e) {
          ...
          .invoke(
            ...
            body: {
              ...
              'data': {
                ...
                if (followUpReminderEnabled != null) 'follow_up_reminder_enabled': followUpReminderEnabled,
                if (followUpDays != null) 'follow_up_days': followUpDays,
                if (pushNotificationEnabled != null) 'push_notification_enabled': pushNotificationEnabled,
                if (communityAnonymousPrefix != null) 'community_anonymous_prefix': communityAnonymousPrefix.value,
                if (communityParticipationEnabled != null) 'community_participation_enabled': communityParticipationEnabled,
              },
            },
          )
          .timeout(_defaultTimeout);
  ...
  /// 코치 설정 초기화
  Future<UserCoachPreferences> resetPreferences({required String userId}) async {
    try {
      final response = await _supabase.functions
          .invoke(
            'coach-personalize',
  ...
  Future<DecisionAnalysisResult> analyzeDecision({
    ...
    try {
      ...
      return DecisionAnalysisResult.fromJson(data['data'] as Map<String, dynamic>);
    } catch (e) {
...
class DecisionAnalysisResult {
  ...
  factory DecisionAnalysisResult.fromJson(Map<String, dynamic> json) {
    return DecisionAnalysisResult(
      ...
      confidenceFactors: (json['confidenceFactors'] as List<dynamic>?)?.cast<String>() ?? [],
