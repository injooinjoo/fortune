...
final adminStatsProvider = FutureProvider.autoDispose<AdminStats>((ref) async {
  ...
  try {
    ...
    throw Exception('통계 데이터를 불러오는 중 오류가 발생했습니다: $e');
  }
});
...
class PackageStat {
  ...
  factory PackageStat.fromJson(Map<String, dynamic> json) {
    return PackageStat(
      ...
      avgCostPerRequest: (json['avgCostPerRequest'] as num).toDouble(),
          ...
          GridView.count(
            ...
            children: [
              ...
              _SummaryCard(
                ...
                subtitle: '비용: ${_formatCurrency(stats.monthly.cost)}',
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _PackageStat(
                          label: '평균 토큰',
                          value: NumberFormat('#,###').format(stat.avgTokensPerRequest.toInt()),
                          fontScale: fontScale,
                        ),
                        _PackageStat(
                          label: '평균 비용',
