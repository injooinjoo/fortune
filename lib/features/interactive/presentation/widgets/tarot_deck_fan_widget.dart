...
class _TarotDeckFanWidgetState extends State<TarotDeckFanWidget>
  ...
  void _onScroll() {
    ...
    if (centerIndex != _hoveredIndex &&
        centerIndex >= 0 &&
        centerIndex < widget.cardCount) {
      setState(() {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return AnimatedBuilder(
            animation:
                Listenable.merge([_fanAnimations[index], _floatController]),
            builder: (context, child) {
              ...
              final floatOffset =
                  isHovered ? _floatController.value * 20 - 10 : 0.0;
                ...
                child: Container(
                  ...
                  child: Transform(
                    ...
                    transform: Matrix4.identity()
                      ..translateByDouble(
                          0.0, -floatOffset + (1 - fanProgress) * 100, 0.0, 0.0)
                      ..rotateZ(angle)
                      ..scaleByDouble(0.9 + scaleBoost + fanProgress * 0.1,
                          0.9 + scaleBoost + fanProgress * 0.1, 1.0, 1.0),
                    child: Opacity(
  ...
  Widget _buildCardBack(
      BuildContext context, int index, bool isHovered, bool isSelected) {
    return Container(
      width: widget.cardWidth,
      height: widget.cardHeight,
      decoration: BoxDecoration(
          ...
          Center(
            child: Icon(Icons.auto_awesome,
                ...
                color: context.colors.accent
                    .withValues(alpha: isHovered ? 0.9 : 0.7)),
          ),
        ],
      ),
    );
...
class MandalaPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      final start = Offset(center.dx + radius * 0.3 * math.cos(angle),
