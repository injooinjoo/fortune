...
class IntentDetector {
  ...
  static const Map<FortuneSurveyType, List<String>> _keywords = {
    ...
    FortuneSurveyType.career: [
      '직업', '취업', '이직', '승진', '커리어', '회사', '일', '직장',
      '면접', '연봉', '월급', '업무', '프리랜서', '창업', '사업',
      '퇴사', '구직', '채용', '합격', '불합격',
    ],
    FortuneSurveyType.love: [
      '연애', '사랑', '남자친구', '여자친구', '남친', '여친',
      '짝사랑', '고백', '데이트', '애인', '커플', '솔로', '만남',
    ],
    FortuneSurveyType.talent: [
      '적성', '재능', '진로', '전공', '능력', '특기', '소질',
      '잠재력', '강점', '약점', '성향',
    ],
