          ...
          children: [
            ...
            _buildSection(
              ...
              'Fortune 앱은 서비스 개선을 위해 다음의 분석 서비스를 이용합니다:\n\n'
                  '• Firebase Analytics: 화면 조회, 기능 사용 흐름 등 익명화된 사용 패턴 분석\n\n'
                  '수집되는 정보:\n'
                  '• 기기 정보 (기기 모델, OS 버전)\n'
                  '• 앱 사용 패턴 (화면 조회, 기능 사용 빈도)\n\n'
                  '이 정보는 개인 식별에 사용되지 않으며, 서비스 품질 향상과 안정적인 운영에만 활용됩니다.',
            ),
            _buildSection(
              '5. 기기 권한 사용',
              'Fortune 앱은 다음의 기기 권한을 사용합니다:\n\n'
                  '• 카메라: Face AI 등 사진 촬영이 필요한 기능 사용 시\n'
                  '• 사진 보관함: 사용자가 직접 선택한 사진 업로드 시\n'
                  '• 마이크: 음성 입력 기능 사용 시\n'
                  '• 음성 인식: 음성을 텍스트로 변환해 입력을 돕는 기능 사용 시\n'
                  '• 위치: 현재 위치 기반 날씨/지역 인사이트 기능 사용 시\n'
                  '• 캘린더: 사용자가 선택한 일정 저장 및 일정 연동 기능 사용 시\n\n'
                  '각 권한은 사용자가 해당 기능을 직접 실행할 때에만 요청되며, 권한을 거부해도 해당 기능 외의 앱 사용에는 제한이 없습니다.',
            ),
            _buildSection(
              '6. 개인정보의 제3자 제공',
              '서비스는 다음의 제3자에게 개인정보를 제공합니다:\n\n'
                  '• Google LLC (Firebase): 기기 정보, 익명화된 앱 사용 데이터 - 서비스 사용성 분석\n'
                  '• Supabase Inc: 이메일, 생년월일 - 회원 관리 및 운세 서비스 제공\n'
                  '• Apple Inc. / Google Play: 구매 정보 - 인앱 결제 처리\n\n'
