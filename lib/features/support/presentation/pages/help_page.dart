            ...
            _buildSection(
              ...
              children: [
                _buildFAQItem(
                  ...
                  answer:
                      '복주머니는 운세를 확인할 때 사용됩니다. 일반 운세는 1개, 프리미엄 운세는 2-3개가 소모됩니다. 매일 무료로 3개의 복주머니를 받을 수 있으며, 추가로 필요한 경우 복주머니를 구매하실 수 있습니다.',
                ),
                _buildFAQItem(
                  context,
                  question: '운세는 얼마나 자주 업데이트되나요?',
                  answer:
                      '일일 운세는 매일 자정에 업데이트되며, 주간 운세는 매주 월요일, 월간 운세는 매월 1일에 업데이트됩니다. 실시간 운세는 조회할 때마다 새로운 결과를 보여드립니다.',
                ),
                _buildFAQItem(
                  context,
                  question: '프리미엄 구독의 혜택은 무엇인가요?',
                  answer:
                      '프리미엄 구독 시 모든 운세를 무제한으로 확인할 수 있으며, 광고 없이 서비스를 이용할 수 있습니다. 또한 프리미엄 전용 운세와 특별한 기능들을 이용하실 수 있습니다.',
                ),
                _buildFAQItem(
                  context,
                  question: '내 정보는 안전한가요?',
                  answer:
                      '네, 모든 개인정보는 암호화되어 안전하게 보관됩니다. 운세 제공 목적 외에는 사용되지 않으며, 제3자에게 제공되지 않습니다.',
                ),
              ],
            ),
