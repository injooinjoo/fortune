...
const List<TimePeriod> timePeriods = [
  TimePeriod(
      ...
      label: '자시 (子時)',
      time: '23:00-01:00',
      description: '밤 11시 ~ 새벽 1시'),
  TimePeriod(
      value: '축시',
      label: '축시 (丑時)',
      time: '01:00-03:00',
      description: '새벽 1시 ~ 새벽 3시'),
  TimePeriod(
      value: '인시',
      label: '인시 (寅時)',
      time: '03:00-05:00',
      description: '새벽 3시 ~ 새벽 5시'),
  TimePeriod(
      value: '묘시',
      label: '묘시 (卯時)',
      time: '05:00-07:00',
      description: '새벽 5시 ~ 오전 7시'),
  TimePeriod(
      value: '진시',
      label: '진시 (辰時)',
      time: '07:00-09:00',
      description: '오전 7시 ~ 오전 9시'),
  TimePeriod(
      value: '사시',
      label: '사시 (巳時)',
      time: '09:00-11:00',
      description: '오전 9시 ~ 오전 11시'),
  TimePeriod(
      value: '오시',
      label: '오시 (午時)',
      time: '11:00-13:00',
      description: '오전 11시 ~ 오후 1시'),
  TimePeriod(
      value: '미시',
      label: '미시 (未時)',
      time: '13:00-15:00',
      description: '오후 1시 ~ 오후 3시'),
  TimePeriod(
      value: '신시',
      label: '신시 (申時)',
      time: '15:00-17:00',
      description: '오후 3시 ~ 오후 5시'),
  TimePeriod(
      value: '유시',
      label: '유시 (酉時)',
      time: '17:00-19:00',
      description: '오후 5시 ~ 오후 7시'),
  TimePeriod(
      value: '술시',
      label: '술시 (戌時)',
      time: '19:00-21:00',
      description: '오후 7시 ~ 오후 9시'),
  TimePeriod(
      value: '해시',
      label: '해시 (亥時)',
      time: '21:00-23:00',
      description: '오후 9시 ~ 오후 11시')
];
...
class FortuneDateUtils {
  ...
  static List<int> getYearOptions() {
    ...
    return List<int>.generate(currentYear - 1899, (i) => currentYear - i);
  }
