...
class FortuneSwipeHelpers {
  ...
  static Map<String, String> getZodiacInfo(String zodiac) {
    final zodiacData = {
      '쥐': {
        'emoji': '🐭',
        'description': '지혜롭고 기민한 쥐띠는 오늘 재정적 기회가 찾아옵니다. 직감을 믿고 빠른 결단이 필요합니다.'
      },
      '소': {
        'emoji': '🐂',
        'description': '성실하고 인내심 강한 소띠는 오늘 꾸준한 노력의 결실을 볼 수 있습니다. 서두르지 마세요.'
      },
      '호랑이': {
        'emoji': '🐯',
        'description': '용감하고 자신감 넘치는 호랑이띠는 오늘 리더십을 발휘할 기회가 있습니다. 앞장서세요.'
      },
      '토끼': {
        'emoji': '🐰',
        'description': '온화하고 섬세한 토끼띠는 오늘 대인관계에서 좋은 일이 생깁니다. 소통에 집중하세요.'
      },
      '용': {
        'emoji': '🐲',
        'description': '강인하고 야망 있는 용띠는 오늘 큰 도약의 기회가 있습니다. 과감한 시도가 길합니다.'
      },
      '뱀': {
        'emoji': '🐍',
        'description': '지혜롭고 직관적인 뱀띠는 오늘 숨겨진 기회를 발견합니다. 관찰력을 발휘하세요.'
      },
      '말': {
        'emoji': '🐴',
        'description': '활기차고 자유로운 말띠는 오늘 새로운 모험이 기다립니다. 에너지를 긍정적으로 쓰세요.'
      },
      '양': {
        'emoji': '🐑',
        'description': '온순하고 예술적인 양띠는 오늘 창의적 영감이 넘칩니다. 감성을 표현해보세요.'
      },
      '원숭이': {
        'emoji': '🐵',
        'description': '영리하고 재치있는 원숭이띠는 오늘 문제 해결 능력이 빛납니다. 유연하게 대처하세요.'
      },
      '닭': {
        'emoji': '🐔',
        'description': '근면하고 정확한 닭띠는 오늘 세심함이 인정받습니다. 디테일에 신경쓰세요.'
      },
      '개': {
        'emoji': '🐶',
        'description': '충직하고 정의로운 개띠는 오늘 신뢰를 얻습니다. 진심을 전하면 좋은 결과가 있습니다.'
      },
      '돼지': {
        'emoji': '🐷',
        'description': '너그럽고 낙천적인 돼지띠는 오늘 풍요로운 기운이 감돕니다. 여유를 즐기세요.'
      },
    };

    return zodiacData[zodiac] ??
        {'emoji': '✨', 'description': '오늘 하루도 좋은 일이 가득하길 바랍니다.'};
  }
  ...
  static Map<String, String> getFallbackTimeSlotAdvice(int score) {
    if (score >= 85) {
      return {
        'morning':
            '아침부터 긍정적인 에너지가 가득합니다. 중요한 미팅이나 업무를 오전에 배치하면 좋은 결과를 얻을 수 있습니다.',
        'afternoon':
            '오후에는 창의적인 아이디어가 떠오를 수 있습니다. 브레인스토밍이나 기획 업무에 집중하기 좋은 시간입니다.',
      ...
      return {
        ...
        'evening':
            '저녁에는 휴식을 취하며 내일을 준비하세요. 가벼운 운동이나 취미 활동으로 마음을 정돈하는 시간이 필요합니다.',
      };
    } else if (score >= 50) {
      return {
  ...
  /// 카테고리 fallback 데이터
  static Map<String, dynamic> getFallbackCategoryData(
      String categoryKey, int baseScore) {
    ...
    final adviceMap = {
      'love':
          '새로운 만남에 열린 마음을 가지세요. 상대방의 감정을 존중하며 진심을 담은 대화를 나누면 좋은 결과가 있을 것입니다. 솔로라면 주변 사람들과의 소소한 만남을 소중히 여기고, 연인이 있다면 감사한 마음을 표현하는 것이 관계를 더욱 깊게 만들어줄 것입니다.',
      'money':
          '계획적인 소비가 도움이 될 것입니다. 충동구매를 자제하고 장기적인 재테크 계획을 세워보세요. 특히 오늘은 불필요한 지출을 줄이고 미래를 위한 저축에 집중하는 것이 좋습니다.',
      'work':
          '꾸준한 노력이 성과로 이어질 것입니다. 동료들과의 협력을 통해 더 큰 성과를 만들어보세요. 오늘은 팀워크가 특히 중요한 날입니다.',
      'study':
          '배움에 대한 열정으로 성과를 거둘 수 있습니다. 계획적인 학습과 복습이 실력 향상의 지름길입니다. 오늘은 집중력이 특히 좋은 날입니다.',
      'health':
          '규칙적인 생활습관을 유지하세요. 충분한 수면과 적절한 운동으로 건강을 지킬 수 있습니다. 오늘은 특히 수면의 질에 신경 쓰는 것이 좋습니다.',
    };
  ...
  static String generateElementExplanation(Map<String, int> elements) {
    ...
    final elementDescriptions = {
      ...
      '화(火)':
          '화기(火氣)가 강하면 열정과 활력이 넘칩니다. 사교성이 좋고 리더십을 발휘하기 쉬우며 사람들과의 관계가 활발합니다.',
