            ...
            children: [
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                    color: context.fortuneTheme.subtitleText, height: 1.5),
                textAlign: TextAlign.center,
              ),
              SizedBox(
                  height:
              ...
              Row(
                ...
                children: List.generate(6, (index) {
                  return Container(
                    width:
                        context.fortuneTheme.socialSharing.shareButtonSize - 8,
                          ...
                          decoration: InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(
                                      context.fortuneTheme.formStyles.inputBorderRadius),
                                  borderSide: BorderSide(color: Theme.of(context).primaryColor, width: context.fortuneTheme.formStyles.focusBorderWidth)),
                              filled: true,
                              fillColor: _controllers[index].text.isNotEmpty ? context.fortuneTheme.cardBackground : context.fortuneTheme.cardSurface),
              ...
              _canResend
                  ...
                  : Text('$_resendTimer초 후 다시 받기',
                      style: Theme.of(context)
                          .textTheme
                          .bodyLarge
                          ?.copyWith(color: context.fortuneTheme.subtitleText)),
              const Spacer(),
              // Verify Button
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(context
                                  .fortuneTheme.bottomSheetStyles.borderRadius +
                              4)),
                      elevation: 0),
                  child: _isLoading
                      ? SizedBox(
                          width:
                              context.fortuneTheme.socialSharing.shareIconSize,
                          height:
                              context.fortuneTheme.socialSharing.shareIconSize,
