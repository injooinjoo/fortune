...
abstract class FortuneRemoteDataSource {
  ...
  Stream<String> generateFortuneStream(String type, Map<String, dynamic> params);
...
class FortuneRemoteDataSourceImpl implements FortuneRemoteDataSource {
  ...
  @override
  Future<Map<String, FortuneResponseModel>> getBatchFortune(List<String> types) async {
    try {
      final response = await _apiClient.post<Map<String, dynamic>>(
  ...
  Future<List<FortuneResponseModel>> getFortuneHistory({
    ...
    try {
      ...
      return data
          .map((json) => FortuneResponseModel.fromJson(json))
          .toList();
    } catch (e) {
      throw _handleError(e);
    }
