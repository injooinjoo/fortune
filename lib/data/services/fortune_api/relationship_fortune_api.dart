...
class RelationshipFortuneApi {
  ...
  Future<Fortune> getCompatibilityFortune(
    ...
    try {
      ...
      final response = await _apiClient.post(ApiEndpoints.compatibilityFortune,
      ...
      Logger.endTimer('getCompatibilityFortune - Total', stopwatch);
      Logger.error(
          '❌ [FortuneApiService] DioException in getCompatibilityFortune', {
      ...
      Logger.endTimer('getCompatibilityFortune - Total', stopwatch);
      Logger.error(
          '❌ [FortuneApiService] Unexpected error in getCompatibilityFortune',
          e,
          stackTrace);
      rethrow;
    }
  ...
  Future<Fortune> getLoveFortune({required String userId}) async {
    ...
    Logger.info(
        '🔍 [FortuneApiService] getLoveFortune called', {'userId': userId});
    ...
    if (cachedFortune != null) {
      Logger.info(
          '💾 [FortuneApiService] Cache hit! Returning cached love fortune',
    ...
    try {
      ...
      await _cacheService.cacheFortune(
          'love', params, _entityToFortuneModel(fortune, 'love'));
      ...
      if (_isNetworkError(e)) {
        ...
        final cachedFortune =
            await _cacheService.getCachedFortune('love', params);
        if (cachedFortune != null) {
      ...
      Logger.endTimer('getLoveFortune - Total', stopwatch);
      Logger.error('❌ [FortuneApiService] Unexpected error in getLoveFortune',
          e, stackTrace);
      rethrow;
    }
  }
