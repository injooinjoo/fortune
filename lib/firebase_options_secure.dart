...
class SecureFirebaseOptions {
  ...
  static FirebaseOptions get ios => FirebaseOptions(
      apiKey: dotenv.env['FIREBASE_IOS_API_KEY'] ??
          _throwMissingKey('FIREBASE_IOS_API_KEY'),
      appId: dotenv.env['FIREBASE_IOS_APP_ID'] ??
          _throwMissingKey('FIREBASE_IOS_APP_ID'),
      messagingSenderId: dotenv.env['FIREBASE_MESSAGING_SENDER_ID'] ??
          _throwMissingKey('FIREBASE_MESSAGING_SENDER_ID'),
      projectId: dotenv.env['FIREBASE_PROJECT_ID'] ??
          _throwMissingKey('FIREBASE_PROJECT_ID'),
  ...
  static FirebaseOptions get macos => FirebaseOptions(
      apiKey: dotenv.env['FIREBASE_MACOS_API_KEY'] ??
          _throwMissingKey('FIREBASE_MACOS_API_KEY'),
      appId: dotenv.env['FIREBASE_MACOS_APP_ID'] ??
          _throwMissingKey('FIREBASE_MACOS_APP_ID'),
      messagingSenderId: dotenv.env['FIREBASE_MESSAGING_SENDER_ID'] ??
          _throwMissingKey('FIREBASE_MESSAGING_SENDER_ID'),
      projectId: dotenv.env['FIREBASE_PROJECT_ID'] ??
          _throwMissingKey('FIREBASE_PROJECT_ID'),
