...
const ATMOSPHERES: Atmosphere[] = [
  {
    mood: "고요한 아침",
    light: "soft golden morning light gently streaming from the east",
    season: "spring",
  },
  {
    mood: "한낮의 햇살 아래",
    light: "bright midday sunlight casting gentle shadows",
  },
  {
    mood: "석양 무렵",
    light: "warm dramatic sunset glow with orange and pink hues",
    season: "autumn",
  },
  {
    mood: "달빛 아래",
    light: "soft silvery moonlight creating a mysterious, ethereal glow",
  },
  {
    mood: "촛불 앞에서",
    light: "warm candlelight creating intimate golden shadows",
  },
  {
    mood: "봄날 꽃비 내리는",
    light: "soft diffused light filtering through cherry blossom petals",
    season: "spring",
  },
  {
    mood: "여름 소나기 후",
    light: "fresh post-rain light with subtle dewy atmosphere",
    season: "summer",
  },
  {
    mood: "가을 단풍 물든",
    light: "golden autumn light filtering through maple leaves",
    season: "autumn",
  },
  {
    mood: "눈 내리는 겨울",
    light: "cool blue-white winter light with soft snowflakes",
    season: "winter",
  },
  {
    mood: "안개 낀 새벽",
    light: "misty pre-dawn light with soft atmospheric haze",
  },
  { mood: "맑은 하늘 아래", light: "clear bright daylight with crisp details" },
  {
    mood: "노을 지는 저녁",
    light: "deep crimson and gold sunset illumination",
  },
];
...
const BACKGROUNDS: Background[] = [
  // 실내 배경
  {
    type: "palace",
    desc:
      "elegant palace interior with ornate wooden screens and silk curtains",
    suitableFor: ["palace", "scholarly"],
  },
  {
    type: "study",
    desc:
      "scholar's study filled with scrolls, brushes, and ink stones on wooden desk",
    suitableFor: ["scholarly", "artisan"],
  },
  {
    type: "tea_room",
    desc:
      "serene traditional tea room with minimal elegance and bamboo accents",
    suitableFor: ["palace", "mystical"],
  },
  {
    type: "workshop",
    desc: "artisan workshop with tools of the trade and works in progress",
    suitableFor: ["artisan", "labor"],
  },
  {
    type: "temple",
    desc: "peaceful Buddhist temple interior with soft incense haze",
    suitableFor: ["mystical", "spiritual"],
  },
  // 실외 배경
  {
    type: "garden",
    desc: "traditional Korean garden with pavilion, lotus pond and pine trees",
    suitableFor: ["palace", "scholarly", "entertainment"],
  },
  {
    type: "mountain",
    desc: "misty mountain backdrop with ancient pine trees and distant peaks",
    suitableFor: ["mystical", "spiritual", "military"],
  },
  {
    type: "market",
    desc: "bustling traditional marketplace with colorful goods and activity",
    suitableFor: ["merchant", "labor"],
  },
  {
    type: "village",
    desc: "peaceful village scene with thatched roof houses and paths",
    suitableFor: ["labor", "merchant"],
  },
  {
    type: "battlefield",
    desc: "dramatic open field with banners and distant mountains",
    suitableFor: ["military"],
  },
  // 추상/심플 배경
  {
    type: "clouds",
    desc: "ethereal clouds and mist like a celestial realm",
    suitableFor: ["mystical", "spiritual"],
  },
  {
    type: "simple",
    desc: "plain aged Hanji paper with natural texture and subtle patina",
    suitableFor: ["all"],
  },
  {
    type: "mist",
    desc: "atmospheric soft mist fading into infinity",
    suitableFor: ["all"],
  },
];
...
const POSES: PoseOption[] = [
  {
    pose:
      "formal seated position on silk cushion, back straight with dignified composure",
    mood: "formal",
  },
  {
    pose:
      "standing with hands clasped in front, in a dignified ceremonial stance",
    mood: "formal",
  },
  {
    pose:
      "mid-action, skillfully performing their craft with focused concentration",
    mood: "active",
  },
  {
    pose:
      "thoughtfully gazing into the distance, as if contemplating life's mysteries",
    mood: "contemplative",
  },
  {
    pose:
      "turning gracefully to the side, captured in an elegant moment of movement",
    mood: "active",
  },
  {
    pose: "seated with meaningful object in hand, embodying their life's work",
    mood: "contemplative",
  },
  {
    pose: "walking with purpose, robes flowing naturally with movement",
    mood: "active",
  },
  {
    pose: "kneeling in respectful posture, hands placed properly on knees",
    mood: "formal",
  },
  {
    pose: "leaning slightly forward with warm, welcoming expression",
    mood: "contemplative",
  },
  {
    pose: "looking over shoulder with knowing smile, as if sharing a secret",
    mood: "active",
  },
];
...
function selectQualityModifier(): string {
  return QUALITY_MODIFIERS[
    Math.floor(Math.random() * QUALITY_MODIFIERS.length)
  ];
}
...
const PLOT_TEMPLATES: Record<PlotType, PlotTemplate> = {
  TRAGEDY: {
    ...
    writingStyle:
      "운명의 아이러니 강조, 절정의 순간 직후 추락, 독자의 연민 유발",
  },
  TRIUMPH: {
    name: "TRIUMPH",
    nameKr: "승리",
...
function selectPlotTemplate(category: string): PlotTemplate {
  const weights = CATEGORY_PLOT_WEIGHTS[category] ||
    CATEGORY_PLOT_WEIGHTS["palace"];
...
const PAST_LIFE_SCENARIOS: PastLifeScenario[] = [
  // ===== 1. 궁궐/관료 (15개) =====
  {
    id: "secretary_trusted",
    category: "palace",
    status: "court_secretary",
    trait: "신뢰받는",
    storySeed: "왕의 비밀 문서를 다루던",
    weight: 10,
  },
  {
    id: "historian_brave",
    ...
    status: "historian",
    trait: "용감한",
    storySeed: "역사의 진실을 기록한",
    weight: 10,
  },
  {
    id: "physician_healing",
    category: "palace",
    status: "royal_physician",
    trait: "자비로운",
    storySeed: "왕실의 건강을 지킨",
    weight: 12,
  },
  {
    id: "eunuch_wise",
    ...
    status: "eunuch",
    trait: "지혜로운",
    storySeed: "궁궐의 비밀을 간직한",
    weight: 8,
  },
  {
    id: "court_lady_elegant",
    category: "palace",
    status: "court_lady",
    trait: "우아한",
    storySeed: "궁중 예법을 지킨",
  ...
  },
  {
    ...
    status: "head_chef",
    trait: "숙련된",
    storySeed: "어전에 수라를 올린",
    weight: 10,
  },
  {
    id: "seamstress_artistic",
    category: "palace",
    status: "seamstress",
    trait: "예술적인",
    storySeed: "왕실 의복에 혼을 담은",
    weight: 10,
  },
  {
    id: "court_painter_talented",
    category: "palace",
    status: "court_painter",
    trait: "재능 있는",
    storySeed: "산수화로 이름난",
    weight: 12,
  },
  {
    id: "portrait_painter_respected",
    category: "palace",
    status: "portrait_painter",
    trait: "존경받는",
    storySeed: "어진을 그린",
    weight: 8,
  },
  {
    id: "garden_keeper_peaceful",
    category: "palace",
    status: "garden_keeper",
    trait: "평화로운",
    storySeed: "궁궐 정원을 가꾼",
    weight: 10,
  },
  ...
  // ===== 2. 무사/군인 (12개) =====
  {
    id: "naval_heroic",
    category: "military",
    status: "naval_commander",
    trait: "용맹한",
    storySeed: "바다에서 적을 물리친",
    weight: 10,
  },
  {
  ...
  },
  {
    ...
    status: "royal_guard",
    trait: "충성스러운",
    storySeed: "왕을 목숨 걸고 호위한",
    weight: 12,
  },
  {
    id: "gate_dignified",
    category: "military",
    status: "gate_commander",
    trait: "위엄 있는",
    storySeed: "궁궐 문을 지킨",
    weight: 10,
  },
  ...
  },
  {
    ...
    status: "secret_agent",
    trait: "충성스러운",
    storySeed: "왕의 밀명을 수행한",
    weight: 8,
  },
  {
    id: "hunter_skilled",
    category: "military",
    status: "bounty_hunter",
    trait: "정의로운",
    storySeed: "악인을 추적한",
    weight: 8,
  },
  {
    ...
    status: "detective",
    trait: "통찰력 있는",
    storySeed: "미궁 사건을 해결한",
    weight: 10,
  },
  {
    id: "archer_legendary",
    category: "military",
    status: "master_archer",
    trait: "전설적인",
    storySeed: "백발백중의",
    weight: 10,
  },
  ...
  // ===== 3. 학문/종교 (12개) =====
  {
    id: "scholar_wise",
    category: "scholarly",
    status: "confucian_scholar",
    trait: "학식 높은",
    storySeed: "성리학의 대가였던",
    weight: 12,
  },
  {
    id: "graduate_brilliant",
    category: "scholarly",
    status: "top_graduate",
    trait: "수재",
    storySeed: "장원급제하여 이름을 날린",
    weight: 10,
  },
  {
    id: "magistrate_just",
    category: "scholarly",
    status: "county_magistrate",
    trait: "공정한",
    storySeed: "백성을 위해 선정을 베푼",
    weight: 12,
  },
  {
    id: "governor_caring",
  ...
  },
  {
    id: "finance_honest",
    category: "scholarly",
    status: "finance_official",
    trait: "청렴한",
    storySeed: "나라 재정을 바르게 관리한",
    weight: 10,
  },
  {
    id: "diplomat_eloquent",
    category: "scholarly",
    status: "diplomat",
    trait: "말솜씨 좋은",
    storySeed: "외교로 나라를 빛낸",
    weight: 10,
  },
  {
    id: "strategist_genius",
    category: "scholarly",
    status: "strategist",
    trait: "천재적인",
    storySeed: "귀신같은 전략을 세운",
    weight: 8,
  },
  {
    id: "monk_enlightened",
    category: "spiritual",
    status: "buddhist_monk",
    trait: "깨달은",
    storySeed: "산사에서 도를 닦은",
    weight: 10,
  },
  {
    id: "poet_free",
    ...
    status: "hermit_poet",
    trait: "자유로운",
    storySeed: "자연 속에서 시를 읊은",
    weight: 12,
  },

  // ===== 4. 신비/술사 (10개) =====
  {
    id: "face_reader_insightful",
    category: "mystical",
    status: "face_reader",
    trait: "통찰력 있는",
    storySeed: "사람의 운명을 읽은",
    weight: 10,
  },
  {
    id: "astronomer_wise",
    ...
    status: "astronomer",
    trait: "하늘의 뜻을 읽는",
    storySeed: "별의 움직임을 해석한",
    weight: 10,
  },
  {
    id: "calendar_precise",
    category: "mystical",
    status: "calendar_maker",
    trait: "정밀한",
    storySeed: "역법을 계산한",
    weight: 8,
  },
  {
    id: "fortune_prophetic",
    category: "mystical",
    status: "fortune_teller",
    trait: "예언의",
    storySeed: "미래를 내다본",
    weight: 10,
  },
  {
    id: "geomancer_respected",
    category: "mystical",
    status: "geomancer",
    trait: "존경받는",
    storySeed: "명당을 찾아낸",
  ...
  },
  {
    id: "ritual_sacred",
    category: "mystical",
    status: "ritual_master",
    trait: "학식 높은",
    storySeed: "제사를 엄숙히 집행한",
    weight: 8,
  },
  {
    id: "shaman_spiritual",
  ...
  },
  {
    ...
    status: "taoist",
    trait: "도를 닦은",
    storySeed: "신선의 경지에 이른",
    weight: 8,
  },
  {
    id: "healer_compassionate",
    category: "mystical",
    status: "healer",
    trait: "치유하는",
    storySeed: "약초로 많은 생명을 살린",
    weight: 12,
  },

  // ===== 5. 상인/장인 (12개) =====
  {
    id: "merchant_adventurous",
    category: "merchant",
    status: "traveling_merchant",
    trait: "활달한",
    storySeed: "전국을 누빈",
    weight: 12,
  },
  {
    id: "silk_wealthy",
    category: "merchant",
    status: "silk_merchant",
    trait: "안목 있는",
    storySeed: "비단으로 거부가 된",
    weight: 10,
  },
  {
    id: "medicine_helpful",
    category: "merchant",
    status: "medicine_merchant",
    trait: "백성을 돕는",
    storySeed: "좋은 약재로 이름난",
    weight: 10,
  },
  {
    id: "ceramicist_master",
    category: "artisan",
    status: "ceramicist",
    trait: "장인의",
    storySeed: "청자를 빚은",
  ...
  {
    id: "paper_traditional",
    category: "artisan",
    status: "paper_maker",
    trait: "전통을 잇는",
    storySeed: "최고의 한지를 만든",
    weight: 10,
  },
  {
    id: "printer_cultured",
    ...
    status: "printer",
    trait: "문화를 전파하는",
    storySeed: "귀한 서적을 인쇄한",
    weight: 10,
  },
  {
    id: "copyist_beautiful",
    category: "artisan",
    status: "copyist",
    trait: "아름다운 글씨의",
    storySeed: "불경을 필사한",
  ...
  },
  {
    id: "armory_trusted",
    category: "military",
    status: "armory_keeper",
    trait: "신뢰받는",
    storySeed: "무기고를 철저히 관리한",
    weight: 8,
  },
  {
    id: "undertaker_dignified",
    category: "labor",
    status: "undertaker",
    trait: "존엄을 지키는",
    storySeed: "망자를 정성껏 모신",
    weight: 10,
  },
  {
    id: "farmer_respected",
  ...
  },
  {
    ...
    status: "servant",
    trait: "지혜로운",
    storySeed: "주인의 신뢰를 얻은",
    weight: 10,
  },

  // ===== 7. 여성 직업 (10개) =====
  {
    id: "female_physician_healing",
    category: "palace",
    status: "female_physician",
    trait: "치유하는",
    storySeed: "여성들의 병을 고친",
    weight: 12,
  },
  {
    id: "head_court_lady_dignified",
    category: "palace",
    status: "head_court_lady",
    trait: "위엄 있는",
    storySeed: "내명부를 총괄한",
    weight: 10,
  },
  {
    id: "embroiderer_artistic",
    category: "artisan",
    status: "embroiderer",
    trait: "예술적인",
    storySeed: "수놓은 작품으로 이름난",
    weight: 10,
  },
  {
    id: "tavern_lively",
    ...
    status: "tavern_owner",
    trait: "활기찬",
    storySeed: "정보가 모이는 주막을 운영한",
    weight: 10,
  },
  {
    id: "female_shaman_spiritual",
    category: "mystical",
    status: "female_shaman",
    trait: "영험한",
    storySeed: "마을의 안녕을 빈",
    weight: 10,
  },
  {
    id: "gisaeng_talented",
    category: "entertainment",
    status: "artistic_gisaeng",
    trait: "재능 있는",
    storySeed: "시와 음악으로 이름난",
    weight: 10,
  },
  {
    id: "wet_nurse_loving",
  ...
  {
    id: "midwife_lifegiver",
    category: "labor",
    status: "midwife",
    trait: "생명을 돕는",
    storySeed: "수많은 아이를 받은",
    weight: 12,
  },
  {
    id: "herb_gatherer_nature",
    category: "labor",
    status: "herb_gatherer",
    trait: "자연과 교감하는",
    storySeed: "산속 약초를 찾아다닌",
    weight: 10,
  },
  {
    id: "weaver_skilled",
  ...
  },
  {
    ...
    status: "clown",
    trait: "사람들을 웃기는",
    storySeed: "온 나라에 웃음을 전한",
    weight: 12,
  },
  {
    id: "tightrope_daring",
    category: "entertainment",
    status: "tightrope_walker",
    trait: "전설적인",
    storySeed: "하늘을 나는 듯한",
    weight: 10,
  },
  {
    id: "mask_dancer_expressive",
    category: "entertainment",
    status: "mask_dancer",
    trait: "표현력 풍부한",
    storySeed: "탈춤으로 이름난",
  ...
  {
    id: "pansori_legendary",
    category: "entertainment",
    status: "pansori_singer",
    trait: "감동을 주는",
    storySeed: "판소리 명창이었던",
    weight: 10,
  },
  ...
  {
    id: "geomungo_master_deep",
    category: "entertainment",
    status: "geomungo_master",
    trait: "깊은 감성의",
    storySeed: "거문고의 대가였던",
    weight: 10,
  },
  {
    id: "flute_master_soulful",
    category: "entertainment",
    status: "flute_master",
    trait: "영혼을 울리는",
    storySeed: "피리 소리로 세상을 감동시킨",
    weight: 10,
  },
];
...
Important: Return ONLY valid JSON, no explanation. Use Korean for values.`;
    ...
    const response = await llm.generate([
      {
        role: "system",
        content:
          "당신은 얼굴 특징 분석 전문가입니다. JSON 형식으로만 응답하세요.",
      },
      {
        role: "user",
        content: [
    ...
    console.log(
      "✅ [PastLife] Face features analyzed:",
 ...
 */
async function generatePortraitWithGemini(
  prompt: string,
): Promise<string | null> {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      console.error(
        `⚠️ [PastLife] Gemini Image API error: ${response.status} - ${errorText}`,
      );
      return null;
    }
    ...
    if (!imagePart || !imagePart.inlineData) {
      ...
      if (textPart) {
        console.log(
          "ℹ️ [PastLife] Gemini text response:",
...
async function getRandomPortraitFromPool(
  ...
  try {
    const { data, error } = await supabase.rpc(
      "get_random_portrait_for_status",
      {
        p_status: status,
        p_gender: gender,
      },
    ...
    if (data && data.length > 0) {
      console.log(
        `♻️ [PastLife] Reusing portrait from pool for ${status}/${gender}`,
      );
...
async function savePortraitToPool(
  ...
  try {
    ...
    if (data) {
      ...
      console.log(
        `ℹ️ [PastLife] Pool full for ${status}/${gender}, not saving`,
      );
    }
...
이 외모적 특징을 전생 캐릭터의 외양과 성격에 자연스럽게 녹여주세요.`;
  ...
  const prompt =
    `당신은 조선시대 전생 이야기를 들려주는 감성 스토리텔러예요! 📜✨
넷플릭스 드라마 보듯 빠져들게, 소름 돋게 재밌는 이야기를 만들어주세요!

## 스타일 가이드 🎬
- 뻔한 전생 스토리 NO! 반전 있는 드라마처럼!
- 첫 문장에서 "어?!" 하게 만들기
- 감정 이입 200%! 독자가 주인공이 된 것처럼
- 조선시대 디테일 + 현대 감성 = 완벽 조합
...
## JSON 응답 형식 (정확히 따라주세요)
{
  ...
  "summary": "당신의 전생은...",
  "chapters": [
    { "title": "${plot.arc[0]}", "content": "...", "emoji": "${
      plot.emojis[0]
    }" },
    { "title": "${plot.arc[1]}", "content": "...", "emoji": "${
      plot.emojis[1]
    }" },
    { "title": "${plot.arc[2]}", "content": "...", "emoji": "${
      plot.emojis[2]
    }" },
    { "title": "${plot.arc[3]}", "content": "...", "emoji": "${
      plot.emojis[3]
    }" },
    { "title": "${plot.arc[4]}", "content": "...", "emoji": "${
      plot.emojis[4]
    }" }
  ],
  "advice": "현생과의 연결점...",
  ...
  const systemPrompt =
    `당신은 넷플릭스급 전생 드라마를 쓰는 감성 스토리텔러예요! 📜✨

역할:
- 첫 문장에서 독자를 사로잡는 훅 마스터!
- 조선시대 덕후급 역사 디테일
- "다음 챕터가 궁금해!" 하게 만드는 전개

규칙:
1. 5개 챕터 필수 (첫 챕터에서 빠져들게!)
2. 각 챕터 150-250자
3. 대사, 감각 묘사로 생생하게
4. "${plot.nameKr}" 플롯 톤 유지
5. JSON 형식 엄수`;
  ...
  console.log(
    "📝 [PastLife] LLM response (first 300 chars):",
  ...
  if (!jsonStr) {
    console.error(
      "❌ [PastLife] No JSON found in response:",
      content.substring(0, 500),
    );
    throw new Error("LLM 응답에서 JSON을 찾을 수 없습니다");
  }

  // trailing comma 제거만 수행 (줄바꿈은 건드리지 않음)
  jsonStr = jsonStr
  ...
  try {
    ...
    console.error("❌ [PastLife] JSON parse error:", e);
    console.error(
      "❌ [PastLife] Raw JSON (first 500 chars):",
      jsonStr.substring(0, 500),
    );
    // 한 번 더 시도: 제어 문자 제거 후 파싱
    try {
      ...
      console.log("✅ [PastLife] JSON parsed after cleanup");
    } catch (e2) {
...
serve(async (req) => {
  ...
  try {
    ...
    if (faceImageBase64) {
      ...
      console.log(
        "👤 [PastLife] Face image provided, generating personalized portrait...",
      );
      ...
      if (imageBase64) {
        ...
        console.log(
          `📷 [PastLife] Using fallback portrait for ${scenario.status}`,
        );
      }
    } else {
      // 얼굴 이미지 없음 → Pool 확인 후 재사용/생성
      const poolCount = await getPortraitCountForStatus(
        scenario.status,
        pastLifeGender,
      );
      console.log(
        `🔍 [PastLife] Pool check: ${scenario.status}/${pastLifeGender} = ${poolCount}/${MAX_PORTRAITS_PER_STATUS}`,
      );

      if (poolCount >= MAX_PORTRAITS_PER_STATUS) {
        // Pool에 충분한 이미지 있음 → 재사용
        const poolPortrait = await getRandomPortraitFromPool(
          scenario.status,
          pastLifeGender,
        );
        ...
        if (imageBase64) {
          ...
          savePortraitToPool(
            ...
            console.error("⚠️ [PastLife] Failed to save to pool:", err)
          );
        } else {
          portraitUrl = getDefaultPortraitUrl(scenario.status);
          console.log(
    ...
    const { story, summary, advice, score, chapters, plotType, llmResponse } =
      await generatePastLifeStory(
        scenario,
        statusConfig.kr,
        pastLifeGender,
        pastLifeEra,
