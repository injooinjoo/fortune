...
\`\`\`json
{
  "전반적인궁합": "전체 궁합 분석 (100자 이내)",
  "궁합점수": 0-100,
  "성격궁합": "성격 조화 분석 (100자 이내)",
  "애정궁합": "애정 관계 분석 (100자 이내)",
  "결혼궁합": "결혼 생활 조화 (100자 이내)",
  "소통궁합": "소통과 이해도 (100자 이내)",
  "강점": ["강점1 (50자 이내)", "강점2", "강점3"],
  "주의점": ["주의점1 (50자 이내)", "주의점2", "주의점3"],
  "조언": ["조언1 (50자 이내)", "조언2", "조언3"],
  "궁합키워드": "한 단어",
  "연애스타일": {
    "person1": "스타일명",
    "person2": "스타일명",
    "조합분석": "스타일 조합 분석 (100자 이내)"
  }
}
\`\`\`
