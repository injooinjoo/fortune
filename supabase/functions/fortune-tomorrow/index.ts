...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Check existing fortune (cache + database) BEFORE token check
    ...
    // Only check token balance if we need to generate new fortune
