...
다음 JSON 형식으로 답변해주세요:
{
  "analysis": "사주 명식의 천간과 지지를 바탕으로 한 전체적인 사주 분석 (150-200자). 핵심 내용별로 \\n\\n으로 문단 구분.",
  "answer": "질문에 대한 구체적이고 상세한 답변 (300-400자). 내용이 길면 \\n\\n으로 문단을 나누어 가독성을 높여주세요.",
  "advice": "실용적인 조언과 주의사항 (200-300자). 조언별로 \\n\\n으로 문단 구분.",
  "supplement": "부족한 오행을 보완하는 구체적인 방법 (150-200자). 방법별로 \\n\\n으로 문단 구분."
}
