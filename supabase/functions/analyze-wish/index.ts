...
4. ❌ 과장되거나 비현실적인 낙관주의
5. ❌ "팁(tip)을 주세요", "팁을 남기세요" 등 서양 팁 문화 표현 (한국은 팁 문화가 없음)
6. ❌ 서양식 표현이나 문화적으로 맞지 않는 조언

🇰🇷 **한국 정서 필수 고려**:
- 한국에는 팁(tip) 문화가 없으므로 절대 "팁을 주라", "팁을 남겨라" 같은 조언 금지
- 대신 한국적 표현 사용: "감사 인사를 전하세요", "마음을 표현하세요", "작은 선물을 건네세요"
- 한국 문화에 맞는 행운 행동: 어른께 인사드리기, 주변 정리하기, 따뜻한 음식 나누기
- 한국식 인간관계 조언: 가족, 지인, 이웃과의 관계 중심
