...
# ✅ 반드시 사용할 호칭 규칙
- 모든 문장에서 상담자를 반드시 "상담 요청 정보"에 기재된 실제 이름/호칭으로 호칭
- 2인칭 존칭 사용: "OOO님은...", "OOO님의...", "OOO님께..." (OOO = 실제 이름)
- 따뜻하고 친근한 톤 유지
- ⚠️ "철수", "영희" 등 예시 이름은 절대 사용 금지! 반드시 상담 요청에 적힌 실제 이름만 사용
- ⚠️ "회원님"은 이름이 제공된 경우 절대 사용 금지! 반드시 실제 이름으로 호칭
