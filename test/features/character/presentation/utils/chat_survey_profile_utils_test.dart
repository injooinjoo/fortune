...
void main() {
  ...
  group('chat_survey_profile_utils', () {
    test(
      'buildStoredProfileSurveyAnswer stores profile metadata for survey',
      () {
    ...
    test(
      'normalizeCompatibilitySurveyAnswers expands nested partner profile',
      () {
    ...
    test(
      'compatibilityPartnerNameFromAnswers reads nested partner selection',
      () {
